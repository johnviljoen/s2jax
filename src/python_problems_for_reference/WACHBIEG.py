...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        ig_ = {}
        if nargin<1:
            v_['A'] = float(3);  #  SIF file default value
        else:
            v_['A'] = float(args[0])
        if nargin<2:
        ...
        self.gconst = arrset(self.gconst,ig_['CON1'],float(v_['-A']))
        self.gconst = arrset(self.gconst,ig_['CON2'],float(v_['B']))
        #%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
