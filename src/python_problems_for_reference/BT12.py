...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = arrset(self.gconst,ig_['CON1'],float(25.0))
        self.gconst = arrset(self.gconst,ig_['CON2'],float(25.0))
        ...
        self.x0[ix_['X1']] = float(15.811)
        self.x0[ix_['X2']] = float(1.5811)
        self.x0[ix_['X3']] = float(0.0)
        self.x0[ix_['X4']] = float(15.083)
        self.x0[ix_['X5']] = float(3.7164)
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
