...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.x0[ix_['B1']] = float(96.0)
        self.x0[ix_['B2']] = float(0.009)
        self.x0[ix_['B3']] = float(103.0)
        self.x0[ix_['B4']] = float(106.0)
        self.x0[ix_['B5']] = float(18.0)
        self.x0[ix_['B6']] = float(72.0)
        self.x0[ix_['B7']] = float(151.0)
        self.x0[ix_['B8']] = float(18.0)
        pass
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
