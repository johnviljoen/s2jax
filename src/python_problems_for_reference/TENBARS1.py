...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        [ig,ig_,_] = s2mpj_ii('STRESS',ig_)
        gtype = arrset(gtype,ig,'<=')
        cnames = arrset(cnames,ig,'STRESS')
        irA  = np.append(irA,[ig])
        ...
        self.gconst = arrset(self.gconst,ig_['STRESS'],float(22.86))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
