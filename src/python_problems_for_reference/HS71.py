...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = arrset(self.gconst,ig_['C1'],float(25.0))
        self.gconst = arrset(self.gconst,ig_['C2'],float(40.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        elftv = loaset(elftv,it,2,'V1')
        elftv = loaset(elftv,it,3,'V2')
        elftv = loaset(elftv,it,4,'V3')
        ...
        self.elftype = arrset(self.elftype,ie,'eLP')
        ielftype = arrset(ielftype,ie,iet_["eLP"])
        vname = 'X1'
        [iv,ix_] = s2mpj_nlx(self,vname,ix_,1,float(1.0),float(5.0),None)
        ...
        ename = 'E2'
        [ie,ie_,_] = s2mpj_ii(ename,ie_)
        self.elftype = arrset(self.elftype,ie,'en4PRD')
        ielftype = arrset(ielftype,ie,iet_["en4PRD"])
        vname = 'X1'
        [iv,ix_] = s2mpj_nlx(self,vname,ix_,1,float(1.0),float(5.0),None)
        posev = np.where(elftv[ielftype[ie]]=='V1')[0]
        self.elvar = loaset(self.elvar,ie,posev[0],iv)
