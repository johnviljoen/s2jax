...
# IE N                   1000           $-PARAMETER
        if nargin<2:
            v_['A'] = float(1.0);  #  SIF file default value
        else:
            v_['A'] = float(args[1])
        if nargin<3:
            v_['K'] = float(10.0);  #  SIF file default value
        else:
            v_['K'] = float(args[2])
# RE L                   0.25           $-PARAMETER original value
        if nargin<4:
            v_['L'] = float(1.0);  #  SIF file default value
        else:
            v_['L'] = float(args[3])
# RE C                   0.75           $-PARAMETER original value
        if nargin<5:
            v_['C'] = float(0.0);  #  SIF file default value
        else:
            v_['C'] = float(args[4])
        v_['1'] = 1
        v_['2'] = 2
