...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.xlower[ix_['1']] = 0.0
        self.xupper[ix_['1']] = 0.0
        ...
        self.xlower[ix_['15']] = 0.0
        self.xupper[ix_['15']] = 0.0
        ...
        self.xlower[ix_['42']] = 0.0
        self.xupper[ix_['42']] = 0.0
        ...
        self.xlower[ix_['50']] = 0.0
        self.xupper[ix_['50']] = 0.0
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
