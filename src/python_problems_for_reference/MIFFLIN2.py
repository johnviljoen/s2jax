...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = arrset(self.gconst,ig_['F1'],float(3.75))
        self.gconst = arrset(self.gconst,ig_['F2'],float(0.25))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        self.grelw = loaset(self.grelw,ig,posel,float(3.75))
        posel = posel+1
