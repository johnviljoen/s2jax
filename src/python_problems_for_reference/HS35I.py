...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = arrset(self.gconst,ig_['OBJ'],float(-9.0))
        ...
        vname = 'X1'
        [iv,ix_] = s2mpj_nlx(self,vname,ix_,1,None,float(5.0),float(0.5))
