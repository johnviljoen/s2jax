...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = arrset(self.gconst,ig_['C1'],float(v_['2+3SQ2']))
        v_['SQ2'] = np.sqrt(2.0)
        v_['2SQ2'] = 2.0*v_['SQ2']
        v_['2SQ2-2'] = -2.0+v_['2SQ2']
        self.gconst = arrset(self.gconst,ig_['C2'],float(v_['2SQ2-2']))
        self.gconst = arrset(self.gconst,ig_['C3'],float(2.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        ename = 'E7'
        [ie,ie_,_] = s2mpj_ii(ename,ie_)
        self.elftype = arrset(self.elftype,ie,'eDQU')
        ielftype = arrset(ielftype,ie,iet_["eDQU"])
        vname = 'X3'
        [iv,ix_] = s2mpj_nlx(self,vname,ix_,1,None,None,float(2.0))
        posev = np.where(elftv[ielftype[ie]]=='X')[0]
        self.elvar = loaset(self.elvar,ie,posev[0],iv)
