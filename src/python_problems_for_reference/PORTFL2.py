...
#    in the return on a typical investor's portfolio. It's important to determine 
...
#    factor 1 to 12 represent the performance of specific asset classes influencing 
    ...
    def __init__(self, *args): 
        ...
        for I in range(int(v_['1']),int(v_['NR'])+1):
            for J in range(int(v_['1']),int(v_['NS'])+1):
                ...
                icA  = np.append(icA,[ix_['S'+str(J)]])
                valA = np.append(valA,float(v_['F'+str(J)+','+str(I)]))
        for I in range(int(v_['1']),int(v_['NS'])+1):
        ...
        for I in range(int(v_['1']),int(v_['NR'])+1):
            self.gconst = arrset(self.gconst,ig_['A'+str(I)],float(v_['R'+str(I)]))
        self.gconst = arrset(self.gconst,ig_['SUM'],float(1.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        v_['SINI'] = 1.0/v_['RNS']
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        self.x0 = np.full((self.n,1),float(v_['SINI']))
        #%%%%%%%%%%%%%%%%%%%%% GRFTYPE %%%%%%%%%%%%%%%%%%%%
        igt_ = {}
