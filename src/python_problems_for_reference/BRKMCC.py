...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        gtype = arrset(gtype,ig,'<>')
        self.gscale = arrset(self.gscale,ig,float(25.0))
        ...
        self.gconst = arrset(self.gconst,ig_['G1'],float(2.0))
        self.gconst = arrset(self.gconst,ig_['G2'],float(1.0))
        self.gconst = arrset(self.gconst,ig_['G3'],float(-1.0))
        self.gconst = arrset(self.gconst,ig_['G4'],float(-1.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        ig = ig_['G3']
        self.grftype = arrset(self.grftype,ig,'gINV')
