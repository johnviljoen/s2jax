...
# IE P                   12             $-PARAMETER n = 3456
        ...
        for J in range(int(v_['1']),int(v_['P'])+1):
            for I in range(int(v_['1']),int(v_['P'])+1):
                for K in range(int(v_['1']),int(v_['P'])+1):
                    ...
                    self.xnames=arrset(self.xnames,iv,'X'+str(I)+','+str(J)+','+str(K))
        #%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        ...
        for I in range(int(v_['2']),int(v_['P-1'])+1):
            ...
            for J in range(int(v_['2']),int(v_['P-1'])+1):
                ...
                for K in range(int(v_['2']),int(v_['P-1'])+1):
                    ...
                    irA  = np.append(irA,[ig])
                    icA  = np.append(icA,[ix_['X'+str(I)+','+str(J)+','+str(K)]])
                    valA = np.append(valA,float(6.0))
                    irA  = np.append(irA,[ig])
                    icA  = np.append(icA,[ix_['X'+str(int(v_['R']))+','+str(J)+','+str(K)]])
                    valA = np.append(valA,float(-1.0))
                    irA  = np.append(irA,[ig])
                    icA  = np.append(icA,[ix_['X'+str(int(v_['S']))+','+str(J)+','+str(K)]])
                    valA = np.append(valA,float(-1.0))
                    irA  = np.append(irA,[ig])
                    icA  = np.append(icA,[ix_['X'+str(I)+','+str(int(v_['V']))+','+str(K)]])
                    valA = np.append(valA,float(-1.0))
                    irA  = np.append(irA,[ig])
                    icA  = np.append(icA,[ix_['X'+str(I)+','+str(int(v_['W']))+','+str(K)]])
                    valA = np.append(valA,float(-1.0))
                    irA  = np.append(irA,[ig])
                    icA  = np.append(icA,[ix_['X'+str(I)+','+str(J)+','+str(int(v_['Y']))]])
                    valA = np.append(valA,float(-1.0))
                    irA  = np.append(irA,[ig])
                    icA  = np.append(icA,[ix_['X'+str(I)+','+str(J)+','+str(int(v_['Z']))]])
                    valA = np.append(valA,float(-1.0))
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        self.n   = len(ix_)
        ngrp   = len(ig_)
        ...
        for J in range(int(v_['1']),int(v_['P'])+1):
            for K in range(int(v_['1']),int(v_['P'])+1):
                ...
                self.xlower[ix_['X'+str(int(v_['1']))+','+str(J)+','+str(K)]] = 0.0
                self.xupper[ix_['X'+str(int(v_['1']))+','+str(J)+','+str(K)]] = 0.0
                self.xlower[ix_['X'+str(int(v_['P']))+','+str(J)+','+str(K)]] = 0.0
                self.xupper[ix_['X'+str(int(v_['P']))+','+str(J)+','+str(K)]] = 0.0
        for I in range(int(v_['2']),int(v_['P-1'])+1):
            for K in range(int(v_['1']),int(v_['P'])+1):
                ...
                self.xlower[ix_['X'+str(I)+','+str(int(v_['P']))+','+str(K)]] = 0.0
                self.xupper[ix_['X'+str(I)+','+str(int(v_['P']))+','+str(K)]] = 0.0
                self.xlower[ix_['X'+str(I)+','+str(int(v_['1']))+','+str(K)]] = 0.0
                self.xupper[ix_['X'+str(I)+','+str(int(v_['1']))+','+str(K)]] = 0.0
        for I in range(int(v_['2']),int(v_['P-1'])+1):
            for J in range(int(v_['2']),int(v_['P-1'])+1):
                ...
                self.xlower[ix_['X'+str(I)+','+str(J)+','+str(int(v_['1']))]] = 0.0
                self.xupper[ix_['X'+str(I)+','+str(J)+','+str(int(v_['1']))]] = 0.0
                self.xlower[ix_['X'+str(I)+','+str(J)+','+str(int(v_['P']))]] = 0.0
                self.xupper[ix_['X'+str(I)+','+str(J)+','+str(int(v_['P']))]] = 0.0
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
