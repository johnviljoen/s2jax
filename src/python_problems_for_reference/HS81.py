...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = arrset(self.gconst,ig_['OBJ'],float(0.5))
        self.gconst = arrset(self.gconst,ig_['C1'],float(10.0))
        self.gconst = arrset(self.gconst,ig_['C3'],float(-1.0))
        #%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xlower = np.zeros((self.n,1))
        self.xupper = np.full((self.n,1),float('inf'))
        self.xlower[ix_['X1']] = -2.3
        self.xupper[ix_['X1']] = 2.3
        self.xlower[ix_['X2']] = -2.3
        self.xupper[ix_['X2']] = 2.3
        self.xlower[ix_['X3']] = -3.2
        self.xupper[ix_['X3']] = 3.2
        self.xlower[ix_['X4']] = -3.2
        self.xupper[ix_['X4']] = 3.2
        self.xlower[ix_['X5']] = -3.2
        self.xupper[ix_['X5']] = 3.2
        #%%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        ...
        ename = 'OBJ2'
        [ie,ie_,_] = s2mpj_ii(ename,ie_)
        self.elftype = arrset(self.elftype,ie,'eX6')
        ielftype = arrset(ielftype,ie,iet_["eX6"])
        vname = 'X1'
        [iv,ix_] = s2mpj_nlx(self,vname,ix_,1,None,None,None)
        ...
        ename = 'OBJ4'
        [ie,ie_,_] = s2mpj_ii(ename,ie_)
        self.elftype = arrset(self.elftype,ie,'eX3Y3')
        ielftype = arrset(ielftype,ie,iet_["eX3Y3"])
        vname = 'X1'
        [iv,ix_] = s2mpj_nlx(self,vname,ix_,1,None,None,None)
        posev = np.where(elftv[ielftype[ie]]=='X')[0]
        self.elvar = loaset(self.elvar,ie,posev[0],iv)
        ...
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt,ig,posel,ie_['OBJ3'])
        nlc = np.union1d(nlc,np.array([ig]))
        self.grelw = loaset(self.grelw,ig,posel,float(-0.5))
        posel = posel+1
        self.grelt = loaset(self.grelt,ig,posel,ie_['OBJ4'])
        self.grelw = loaset(self.grelw,ig,posel,float(-1.0))
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt,ig,posel,ie_['OBJ5'])
        nlc = np.union1d(nlc,np.array([ig]))
        self.grelw = loaset(self.grelw,ig,posel,float(-1.0))
        posel = posel+1
        self.grelt = loaset(self.grelt,ig,posel,ie_['OBJ6'])
        self.grelw = loaset(self.grelw,ig,posel,float(-1.0))
        ig = ig_['C1']
        posel = len(self.grelt[ig])
