...
# IE N                   99997          $-PARAMETER
        ...
        for K in range(int(v_['1']),int(v_['NC'])+1,int(v_['3'])):
            ...
            self.gconst = arrset(self.gconst,ig_['C'+str(int(v_['K+1']))],float(1.0))
            self.gconst = arrset(self.gconst,ig_['C'+str(int(v_['K+2']))],float(1.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
