...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = arrset(self.gconst,ig_['F'],float(v_['TAU']))
        ...
        if('X1' in ix_):
            ...
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X1']),float(1.1)))
        if('X2' in ix_):
        ...
        self.grelw = loaset(self.grelw,ig,posel,float(v_['TAU']))
        posel = len(self.grelt[ig])
