...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.elftype = arrset(self.elftype,ie,'eMCB')
        ielftype = arrset(ielftype,ie,iet_["eMCB"])
        vname = 'X1'
