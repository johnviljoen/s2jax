...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        v_['-A'] = -1.0*v_['A']
        self.gconst = arrset(self.gconst,ig_['C1'],float(v_['-A']))
        self.gconst = arrset(self.gconst,ig_['C2'],float(v_['-A']))
        self.gconst = arrset(self.gconst,ig_['C3'],float(-894.8))
        self.gconst = arrset(self.gconst,ig_['C4'],float(-894.8))
        self.gconst = arrset(self.gconst,ig_['C5'],float(-1294.8))
        #%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xlower = np.zeros((self.n,1))
        self.xupper = np.full((self.n,1),float('inf'))
        self.xupper[ix_['X1']] = 1200.0
        self.xupper[ix_['X2']] = 1200.0
        self.xlower[ix_['X3']] = v_['-A']
        self.xupper[ix_['X3']] = v_['A']
        self.xlower[ix_['X4']] = v_['-A']
        self.xupper[ix_['X4']] = v_['A']
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
