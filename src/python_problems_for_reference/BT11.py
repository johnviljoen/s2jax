...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        v_['ROOT18'] = np.sqrt(18.0)
        v_['ROOT8'] = np.sqrt(8.0)
        v_['C1'] = -2.0+v_['ROOT18']
        v_['C2'] = -2.0+v_['ROOT8']
        self.gconst = arrset(self.gconst,ig_['CON1'],float(v_['C1']))
        self.gconst = arrset(self.gconst,ig_['CON2'],float(v_['C2']))
        ...
        self.grelw = loaset(self.grelw,ig,posel,1.)
        posel = posel+1
        self.grelt = loaset(self.grelt,ig,posel,ie_['X3CB'])
        self.grelw = loaset(self.grelw,ig,posel, 1.)
        ig = ig_['CON2']
        posel = len(self.grelt[ig])
