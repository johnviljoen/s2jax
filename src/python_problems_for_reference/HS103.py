...
# **********************
    ...
    def en3PR(self, nargout,*args):
        ...
        if nargout>1:
            try:
                ...
                dim = len(EV_)
            g_ = np.zeros(dim)
            g_[0] = FVALUE*(self.elpar[iel_][0]/EV_[0])
            g_[1] = FVALUE*(self.elpar[iel_][1]/EV_[1])
            g_[2] = FVALUE*(self.elpar[iel_][2]/EV_[2])
            if nargout>2:
                H_ = np.zeros((3,3))
                H_[0,0]  = (
                ...
                H_[0,1] = FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][1]/EV_[1])
                H_[1,0] = H_[0,1]
                H_[0,2] = FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][2]/EV_[2])
                H_[2,0] = H_[0,2]
                H_[1,2] = FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][2]/EV_[2])
                H_[2,1] = H_[1,2]
        if nargout == 1:
            return f_
        elif nargout == 2:
    ...
    def en4PR(self, nargout,*args):
        ...
        if nargout>1:
            ...
            g_[1] = FVALUE*(self.elpar[iel_][1]/EV_[1])
            g_[2] = FVALUE*(self.elpar[iel_][2]/EV_[2])
            g_[3] = FVALUE*(self.elpar[iel_][3]/EV_[3])
            if nargout>2:
                H_ = np.zeros((4,4))
                H_[0,0]  = (
                      FVALUE*(self.elpar[iel_][0]/EV_[0])*((self.elpar[iel_][0]-1.0)/EV_[0]))
                ...
                H_[0,2] = FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][2]/EV_[2])
                H_[2,0] = H_[0,2]
                H_[0,3] = FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][3]/EV_[3])
                H_[3,0] = H_[0,3]
                H_[1,2] = FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][2]/EV_[2])
                H_[2,1] = H_[1,2]
                H_[1,3] = FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][3]/EV_[3])
                H_[3,1] = H_[1,3]
                H_[2,3] = FVALUE*(self.elpar[iel_][2]/EV_[2])*(self.elpar[iel_][3]/EV_[3])
                H_[3,2] = H_[2,3]
        if nargout == 1:
            return f_
        elif nargout == 2:
    ...
    def en5PR(self, nargout,*args):
        ...
        if nargout>1:
            ...
            g_[2] = FVALUE*(self.elpar[iel_][2]/EV_[2])
            g_[3] = FVALUE*(self.elpar[iel_][3]/EV_[3])
            g_[4] = FVALUE*(self.elpar[iel_][4]/EV_[4])
            if nargout>2:
                H_ = np.zeros((5,5))
                H_[0,0]  = (
                      FVALUE*(self.elpar[iel_][0]/EV_[0])*((self.elpar[iel_][0]-1.0)/EV_[0]))
                ...
                H_[0,3] = FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][3]/EV_[3])
                H_[3,0] = H_[0,3]
                H_[0,4] = FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][4]/EV_[4])
                H_[4,0] = H_[0,4]
                H_[1,2] = FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][2]/EV_[2])
                H_[2,1] = H_[1,2]
                H_[1,3] = FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][3]/EV_[3])
                H_[3,1] = H_[1,3]
                H_[1,4] = FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][4]/EV_[4])
                H_[4,1] = H_[1,4]
                H_[2,3] = FVALUE*(self.elpar[iel_][2]/EV_[2])*(self.elpar[iel_][3]/EV_[3])
                H_[3,2] = H_[2,3]
                H_[2,4] = FVALUE*(self.elpar[iel_][2]/EV_[2])*(self.elpar[iel_][4]/EV_[4])
                H_[4,2] = H_[2,4]
                H_[3,4] = FVALUE*(self.elpar[iel_][3]/EV_[3])*(self.elpar[iel_][4]/EV_[4])
                H_[4,3] = H_[3,4]
        if nargout == 1:
            return f_
        elif nargout == 2:
    ...
    def en6PR(self, nargout,*args):
        ...
        if nargout>1:
            ...
            g_ = np.zeros(dim)
            g_[0] = FVALUE*(self.elpar[iel_][0]/EV_[0])
            g_[1] = FVALUE*(self.elpar[iel_][2]/EV_[1])
            g_[2] = FVALUE*(self.elpar[iel_][3]/EV_[2])
            g_[3] = FVALUE*(self.elpar[iel_][4]/EV_[3])
            g_[4] = FVALUE*(self.elpar[iel_][5]/EV_[4])
            g_[5] = FVALUE*(self.elpar[iel_][1]/EV_[5])
            if nargout>2:
                H_ = np.zeros((6,6))
                H_[0,0]  = (
                      FVALUE*(self.elpar[iel_][0]/EV_[0])*((self.elpar[iel_][0]-1.0)/EV_[0]))
                ...
                H_[0,1] = FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][2]/EV_[1])
                H_[1,0] = H_[0,1]
                H_[0,2] = FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][3]/EV_[2])
                H_[2,0] = H_[0,2]
                H_[0,3] = FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][4]/EV_[3])
                H_[3,0] = H_[0,3]
                H_[0,4] = FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][5]/EV_[4])
                H_[4,0] = H_[0,4]
                H_[0,5] = FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][1]/EV_[5])
                H_[5,0] = H_[0,5]
                H_[1,2] = FVALUE*(self.elpar[iel_][2]/EV_[1])*(self.elpar[iel_][3]/EV_[2])
                H_[2,1] = H_[1,2]
                H_[1,3] = FVALUE*(self.elpar[iel_][2]/EV_[1])*(self.elpar[iel_][4]/EV_[3])
                H_[3,1] = H_[1,3]
                H_[1,4] = FVALUE*(self.elpar[iel_][2]/EV_[1])*(self.elpar[iel_][5]/EV_[4])
                H_[4,1] = H_[1,4]
                H_[1,5] = FVALUE*(self.elpar[iel_][2]/EV_[1])*(self.elpar[iel_][1]/EV_[5])
                H_[5,1] = H_[1,5]
                H_[2,3] = FVALUE*(self.elpar[iel_][3]/EV_[2])*(self.elpar[iel_][4]/EV_[3])
                H_[3,2] = H_[2,3]
                H_[2,4] = FVALUE*(self.elpar[iel_][3]/EV_[2])*(self.elpar[iel_][5]/EV_[4])
                H_[4,2] = H_[2,4]
                H_[2,5] = FVALUE*(self.elpar[iel_][3]/EV_[2])*(self.elpar[iel_][1]/EV_[5])
                H_[5,2] = H_[2,5]
                H_[3,4] = FVALUE*(self.elpar[iel_][4]/EV_[3])*(self.elpar[iel_][5]/EV_[4])
                H_[4,3] = H_[3,4]
                H_[3,5] = FVALUE*(self.elpar[iel_][4]/EV_[3])*(self.elpar[iel_][1]/EV_[5])
                H_[5,3] = H_[3,5]
                H_[4,5] = FVALUE*(self.elpar[iel_][5]/EV_[4])*(self.elpar[iel_][1]/EV_[5])
                H_[5,4] = H_[4,5]
        if nargout == 1:
            return f_
        elif nargout == 2:
