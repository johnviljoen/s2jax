...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.xlower[ix_['X1']] = -10.0
        self.xlower[ix_['X2']] = 1.0
        self.xlower[ix_['X3']] = -10.0
        self.xupper[ix_['X1']] = 10.0
        self.xupper[ix_['X2']] = 10.0
        ...
        self.grelw = loaset(self.grelw,ig,posel,float(9.0))
        posel = posel+1
        ...
        ig = ig_['CONSTR']
        posel = len(self.grelt[ig])
        self.grelt = loaset(self.grelt,ig,posel,ie_['CONSTR1'])
        nlc = np.union1d(nlc,np.array([ig]))
        self.grelw = loaset(self.grelw,ig,posel,1.)
        #%%%%%%%%%%%%%%%%%% OBJECT BOUNDS %%%%%%%%%%%%%%%%%
#   Solution
