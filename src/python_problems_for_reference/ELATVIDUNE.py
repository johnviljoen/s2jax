...
class  ELATVIDUNE(CUTEst_problem):
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = arrset(self.gconst,ig_['F1'],float(10.0))
        self.gconst = arrset(self.gconst,ig_['F2'],float(7.0))
        self.gconst = arrset(self.gconst,ig_['F3'],float(1.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
