...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = arrset(self.gconst,ig_['C1'],float(4.97))
        self.gconst = arrset(self.gconst,ig_['C2'],float(-1.88))
        self.gconst = arrset(self.gconst,ig_['C3'],float(-69.08))
        self.gconst = arrset(self.gconst,ig_['C4'],float(-118.02))
        #%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
