from s2jax.reference import *
class  HYDCAR20(CUTEst_problem):
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        if('X0,2' in ix_):
            self.x0[ix_['X0,2']] = float(0.3)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X0,2']),float(0.3)))
        if('X0,3' in ix_):
            self.x0[ix_['X0,3']] = float(0.1)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X0,3']),float(0.1)))
        if('X1,1' in ix_):
        ...
        if('X1,2' in ix_):
            self.x0[ix_['X1,2']] = float(0.3)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X1,2']),float(0.3)))
        if('X1,3' in ix_):
            self.x0[ix_['X1,3']] = float(0.9)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X1,3']),float(0.9)))
        if('X2,1' in ix_):
            self.x0[ix_['X2,1']] = float(0.01)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X2,1']),float(0.01)))
        if('X2,2' in ix_):
        ...
        if('X2,3' in ix_):
            self.x0[ix_['X2,3']] = float(0.9)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X2,3']),float(0.9)))
        if('X3,1' in ix_):
            self.x0[ix_['X3,1']] = float(0.02)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X3,1']),float(0.02)))
        if('X3,2' in ix_):
            self.x0[ix_['X3,2']] = float(0.4)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X3,2']),float(0.4)))
        if('X3,3' in ix_):
            self.x0[ix_['X3,3']] = float(0.8)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X3,3']),float(0.8)))
        if('X4,1' in ix_):
            self.x0[ix_['X4,1']] = float(0.05)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X4,1']),float(0.05)))
        if('X4,2' in ix_):
            self.x0[ix_['X4,2']] = float(0.4)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X4,2']),float(0.4)))
        if('X4,3' in ix_):
            self.x0[ix_['X4,3']] = float(0.8)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X4,3']),float(0.8)))
        if('X5,1' in ix_):
            self.x0[ix_['X5,1']] = float(0.07)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X5,1']),float(0.07)))
        if('X5,2' in ix_):
            self.x0[ix_['X5,2']] = float(0.45)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X5,2']),float(0.45)))
        if('X5,3' in ix_):
            self.x0[ix_['X5,3']] = float(0.8)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X5,3']),float(0.8)))
        if('X6,1' in ix_):
            self.x0[ix_['X6,1']] = float(0.09)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X6,1']),float(0.09)))
        if('X6,2' in ix_):
            self.x0[ix_['X6,2']] = float(0.5)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X6,2']),float(0.5)))
        if('X6,3' in ix_):
            self.x0[ix_['X6,3']] = float(0.7)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X6,3']),float(0.7)))
        if('X7,1' in ix_):
            self.x0[ix_['X7,1']] = float(0.1)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X7,1']),float(0.1)))
        if('X7,2' in ix_):
            self.x0[ix_['X7,2']] = float(0.5)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X7,2']),float(0.5)))
        if('X7,3' in ix_):
            self.x0[ix_['X7,3']] = float(0.7)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X7,3']),float(0.7)))
        if('X8,1' in ix_):
            self.x0[ix_['X8,1']] = float(0.15)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X8,1']),float(0.15)))
        if('X8,2' in ix_):
            self.x0[ix_['X8,2']] = float(0.5)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X8,2']),float(0.5)))
        if('X8,3' in ix_):
            self.x0[ix_['X8,3']] = float(0.6)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X8,3']),float(0.6)))
        if('X9,1' in ix_):
            self.x0[ix_['X9,1']] = float(0.2)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X9,1']),float(0.2)))
        if('X9,2' in ix_):
            self.x0[ix_['X9,2']] = float(0.5)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X9,2']),float(0.5)))
        if('X9,3' in ix_):
            self.x0[ix_['X9,3']] = float(0.6)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X9,3']),float(0.6)))
        if('X10,1' in ix_):
            self.x0[ix_['X10,1']] = float(0.25)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X10,1']),float(0.25)))
        if('X10,2' in ix_):
            self.x0[ix_['X10,2']] = float(0.6)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X10,2']),float(0.6)))
        if('X10,3' in ix_):
            self.x0[ix_['X10,3']] = float(0.5)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X10,3']),float(0.5)))
        if('X11,1' in ix_):
            self.x0[ix_['X11,1']] = float(0.3)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X11,1']),float(0.3)))
        if('X11,2' in ix_):
            self.x0[ix_['X11,2']] = float(0.6)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X11,2']),float(0.6)))
        if('X11,3' in ix_):
            self.x0[ix_['X11,3']] = float(0.5)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X11,3']),float(0.5)))
        if('X12,1' in ix_):
            self.x0[ix_['X12,1']] = float(0.35)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X12,1']),float(0.35)))
        if('X12,2' in ix_):
            self.x0[ix_['X12,2']] = float(0.6)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X12,2']),float(0.6)))
        if('X12,3' in ix_):
            self.x0[ix_['X12,3']] = float(0.5)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X12,3']),float(0.5)))
        if('X13,1' in ix_):
            self.x0[ix_['X13,1']] = float(0.4)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X13,1']),float(0.4)))
        if('X13,2' in ix_):
            self.x0[ix_['X13,2']] = float(0.6)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X13,2']),float(0.6)))
        if('X13,3' in ix_):
            self.x0[ix_['X13,3']] = float(0.4)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X13,3']),float(0.4)))
        if('X14,1' in ix_):
            self.x0[ix_['X14,1']] = float(0.4)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X14,1']),float(0.4)))
        if('X14,2' in ix_):
            self.x0[ix_['X14,2']] = float(0.7)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X14,2']),float(0.7)))
        if('X14,3' in ix_):
            self.x0[ix_['X14,3']] = float(0.4)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X14,3']),float(0.4)))
        if('X15,1' in ix_):
            self.x0[ix_['X15,1']] = float(0.42)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X15,1']),float(0.42)))
        if('X15,2' in ix_):
            self.x0[ix_['X15,2']] = float(0.7)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X15,2']),float(0.7)))
        if('X15,3' in ix_):
            self.x0[ix_['X15,3']] = float(0.3)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X15,3']),float(0.3)))
        if('X16,1' in ix_):
            self.x0[ix_['X16,1']] = float(0.45)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X16,1']),float(0.45)))
        if('X16,2' in ix_):
            self.x0[ix_['X16,2']] = float(0.75)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X16,2']),float(0.75)))
        if('X16,3' in ix_):
            self.x0[ix_['X16,3']] = float(0.3)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X16,3']),float(0.3)))
        if('X17,1' in ix_):
            self.x0[ix_['X17,1']] = float(0.45)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X17,1']),float(0.45)))
        if('X17,2' in ix_):
            self.x0[ix_['X17,2']] = float(0.75)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X17,2']),float(0.75)))
        if('X17,3' in ix_):
            self.x0[ix_['X17,3']] = float(0.2)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X17,3']),float(0.2)))
        if('X18,1' in ix_):
            self.x0[ix_['X18,1']] = float(0.5)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X18,1']),float(0.5)))
        if('X18,2' in ix_):
            self.x0[ix_['X18,2']] = float(0.8)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X18,2']),float(0.8)))
        if('X18,3' in ix_):
            self.x0[ix_['X18,3']] = float(0.1)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X18,3']),float(0.1)))
        if('X19,1' in ix_):
            self.x0[ix_['X19,1']] = float(0.5)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X19,1']),float(0.5)))
        if('X19,2' in ix_):
            self.x0[ix_['X19,2']] = float(0.8)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X19,2']),float(0.8)))
        if('X19,3' in ix_):
            self.x0[ix_['X19,3']] = float(0.0)
        else:
            self.y0  = (
                  arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X19,3']),float(0.0)))
        for I in range(int(v_['0']),int(v_['N-1'])+1):
            if('T'+str(I) in ix_):
