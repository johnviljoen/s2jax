...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.x0 = jtu.np_like_set(self.x0, ix_['X2'], float(-1.2))
        self.x0 = jtu.np_like_set(self.x0, ix_['X3'], float(0.98))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
    ...
    def eXPEXP(self, nargout,*args):
        ...
        if nargout>1:
            ...
            g_ = jtu.np_like_set(g_, 1, self.elpar[iel_][0]*EV_[0]*EV_[1]**(IT-1))
            if nargout>2:
                H_ = jnp.zeros((2,2))
