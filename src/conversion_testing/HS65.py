...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        icA  = jtu.append(icA,[ix_['X2']])
        valA = jtu.append(valA,float(1.0))
        self.gscale = jtu.arrset(self.gscale,ig,float(9.0))
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['OBJ2'],float(10.0))
        self.gconst = jtu.arrset(self.gconst,ig_['OBJ3'],float(5.0))
        self.gconst = jtu.arrset(self.gconst,ig_['C1'],float(-48.0))
        #%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xlower = jnp.zeros((self.n,1))
        self.xupper = jnp.full((self.n,1),float('inf'))
        self.xlower = jtu.np_like_set(self.xlower, ix_['X1'], -4.5)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X1'], 4.5)
        self.xlower = jtu.np_like_set(self.xlower, ix_['X2'], -4.5)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X2'], 4.5)
        self.xlower = jtu.np_like_set(self.xlower, ix_['X3'], -5.0)
