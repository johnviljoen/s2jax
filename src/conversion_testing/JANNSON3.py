...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        for I in range(int(v_['1']),int(v_['2N'])+1):
            ...
            gtype = jtu.arrset(gtype,ig,'==')
            cnames = jtu.arrset(cnames,ig,'L')
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['X'+str(I)]])
            valA = jtu.append(valA,float(1.0))
        [ig,ig_,_] = jtu.s2mpj_ii('Q',ig_)
        gtype = jtu.arrset(gtype,ig,'<=')
        cnames = jtu.arrset(cnames,ig,'Q')
        [ig,ig_,_] = jtu.s2mpj_ii('P',ig_)
        gtype = jtu.arrset(gtype,ig,'<=')
        cnames = jtu.arrset(cnames,ig,'P')
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        self.n   = len(ix_)
        ngrp   = len(ig_)
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['G0'],float(1.0))
        for I in range(int(v_['1']),int(v_['2N'])+1):
            self.gconst = jtu.arrset(self.gconst,ig_['G'+str(I)],float(1.0))
        self.gconst = jtu.arrset(self.gconst,ig_['L'],float(1.0))
        self.gconst = jtu.arrset(self.gconst,ig_['Q'],float(0.75))
        self.gconst = jtu.arrset(self.gconst,ig_['P'],float(v_['1/5N']))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        [it,igt_,_] = jtu.s2mpj_ii('gL22',igt_)
        #%%%%%%%%%%%%%%%%%%% GROUP USES %%%%%%%%%%%%%%%%%%%
        self.grelt   = []
        ...
        nlc         = jnp.array([])
        ig = ig_['G']
        self.grftype = jtu.arrset(self.grftype,ig,'gL22')
