...
# IE N                   99998          $-PARAMETER
        ...
        for K in range(int(v_['1']),int(v_['NC'])+1,int(v_['2'])):
            ...
            self.gconst = jtu.arrset(self.gconst,ig_['C'+str(int(v_['K+1']))],float(6.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        for I in range(int(v_['1']),int(v_['N'])+1,int(v_['3'])):
            self.x0 = jtu.np_like_set(self.x0, ix_['X'+str(I)], float(10.0))
        for I in range(int(v_['2']),int(v_['N'])+1,int(v_['3'])):
            self.x0 = jtu.np_like_set(self.x0, ix_['X'+str(I)], float(7.0))
