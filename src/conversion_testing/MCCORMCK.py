...
# IE N                   50000          $-PARAMETER
        ...
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xlower = jnp.full((self.n,1),-1.5)
        self.xupper = jnp.full((self.n,1),3.0)
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
        ...
        for I in range(int(v_['1']),int(v_['N-1'])+1):
            ...
            [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,float(-1.5),float(3.0),None)
