...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        if('X3' in ix_):
            ...
            self.y0  = (
                  jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X3']),float(0.9)))
        if('X4' in ix_):
        ...
        if('X5' in ix_):
            ...
            self.y0  = (
                  jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X5']),float(0.14)))
        if('X6' in ix_):
        ...
        if('X7' in ix_):
            ...
            self.y0  = (
                  jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X7']),float(489.0)))
        if('X8' in ix_):
        ...
        if('X9' in ix_):
            ...
            self.y0  = (
                  jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X9']),float(650.0)))
        if('X10' in ix_):
        ...
        if('X11' in ix_):
            ...
            self.y0  = (
                  jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X11']),float(150.0)))
        if('X12' in ix_):
        ...
        if('X13' in ix_):
            ...
            self.y0  = (
                  jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X13']),float(150.0)))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
