...
# IE N                   5000           $-PARAMETER n=10002, m=5001
        ...
        for I in range(int(v_['0']),int(v_['N'])+1):
            ...
            self.xscale = jtu.arrset(self.xscale,iv,v_['RN'])
        #%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        ...
        valA = jtu.append(valA,float(-1.0))
        self.gscale = jtu.arrset(self.gscale,ig,float(v_['H']))
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        self.n   = len(ix_)
        ngrp   = len(ig_)
        ...
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        self.x0 = jnp.full((self.n,1),float(0.25))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
        ...
        for I in range(int(v_['0']),int(v_['N'])+1):
            ...
            vname = 'X'+str(I)
            [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,None,None,float(0.25))
