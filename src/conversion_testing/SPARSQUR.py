...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        iet_  = {}
        elftv = []
        [it,iet_,_] = jtu.s2mpj_ii( 'eSQUR', iet_)
        ...
        for I in range(int(v_['1']),int(v_['N'])+1):
            ...
            self.elftype = jtu.arrset(self.elftype,ie,'eSQUR')
            ielftype = jtu.arrset(ielftype,ie,iet_["eSQUR"])
            vname = 'X'+str(I)
...
# **********************
    ...
    def eSQUR(self, nargout,*args):
        ...
        if nargout>1:
            ...
            if nargout>2:
                H_ = jnp.zeros((1,1))
                H_ = jtu.np_like_set(H_, jnp.array([0,0]), 1.0e0)
        if nargout == 1:
            return f_
        elif nargout == 2:
            return f_,g_
