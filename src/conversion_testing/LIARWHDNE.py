...
# IE N                   10000          $-PARAMETER
        ...
        for I in range(int(v_['1']),int(v_['N'])+1):
            ...
            self.gscale = jtu.arrset(self.gscale,ig,float(v_['ROOOTP25']))
        ...
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        self.x0 = jnp.full((self.n,1),float(4.0))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
        ...
        for I in range(int(v_['1']),int(v_['N'])+1):
            ...
            vname = 'X'+str(I)
            [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,None,None,float(4.0))
