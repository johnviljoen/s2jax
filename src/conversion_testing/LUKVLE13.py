...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        ig_ = {}
        if nargin<1:
            v_['N'] = int(20);  #  SIF file default value
        else:
            v_['N'] = int(args[0])
# IE N                   99998          $-PARAMETER
        ...
        for I in range(int(v_['1']),int(v_['(N-2)/3'])+1):
            self.gconst = jtu.arrset(self.gconst,ig_['OBJ1'+str(I)],float(1.0))
        for K in range(int(v_['1']),int(v_['NC'])+1,int(v_['2'])):
            v_['K+1'] = 1+K
            self.gconst = jtu.arrset(self.gconst,ig_['C'+str(K)],float(5.0))
            self.gconst = jtu.arrset(self.gconst,ig_['C'+str(int(v_['K+1']))],float(3.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        for I in range(int(v_['2']),int(v_['N'])+1,int(v_['3'])):
            self.x0 = jtu.np_like_set(self.x0, ix_['X'+str(I)], float(5.0))
