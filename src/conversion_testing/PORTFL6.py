    ...
    def __init__(self, *args): 
        ...
        for I in range(int(v_['1']),int(v_['NR'])+1):
            for J in range(int(v_['1']),int(v_['NS'])+1):
                ...
                icA  = jtu.append(icA,[ix_['S'+str(J)]])
                valA = jtu.append(valA,float(v_['F'+str(J)+','+str(I)]))
        for I in range(int(v_['1']),int(v_['NS'])+1):
        ...
        for I in range(int(v_['1']),int(v_['NR'])+1):
            self.gconst = jtu.arrset(self.gconst,ig_['A'+str(I)],float(v_['R'+str(I)]))
        self.gconst = jtu.arrset(self.gconst,ig_['SUM'],float(1.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        v_['SINI'] = 1.0/v_['RNS']
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        self.x0 = jnp.full((self.n,1),float(v_['SINI']))
        #%%%%%%%%%%%%%%%%%%%%% GRFTYPE %%%%%%%%%%%%%%%%%%%%
        igt_ = {}
