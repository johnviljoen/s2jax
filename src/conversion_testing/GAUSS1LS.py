...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.x0 = jtu.np_like_set(self.x0, ix_['B1'], float(97.0))
        self.x0 = jtu.np_like_set(self.x0, ix_['B2'], float(0.009))
        self.x0 = jtu.np_like_set(self.x0, ix_['B3'], float(100.0))
        self.x0 = jtu.np_like_set(self.x0, ix_['B4'], float(65.0))
        self.x0 = jtu.np_like_set(self.x0, ix_['B5'], float(20.0))
        self.x0 = jtu.np_like_set(self.x0, ix_['B6'], float(70.0))
        self.x0 = jtu.np_like_set(self.x0, ix_['B7'], float(178.0))
        self.x0 = jtu.np_like_set(self.x0, ix_['B8'], float(16.5))
        pass
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
