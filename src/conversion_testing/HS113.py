...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        valA = jtu.append(valA,float(-16.0))
        irA  = jtu.append(irA,[ig])
        ...
        valA = jtu.append(valA,float(-154.0))
        irA  = jtu.append(irA,[ig])
        ...
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['X8']])
        valA = jtu.append(valA,float(-9.0))
        ...
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['X2']])
        valA = jtu.append(valA,float(24.0))
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['X4']])
        ...
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['X9']])
        valA = jtu.append(valA,float(192.0))
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['X10']])
        valA = jtu.append(valA,float(7.0))
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['OBJ'],float(-1352.0))
        self.gconst = jtu.arrset(self.gconst,ig_['C1'],float(-105.0))
        self.gconst = jtu.arrset(self.gconst,ig_['C3'],float(-12.0))
        self.gconst = jtu.arrset(self.gconst,ig_['C4'],float(-72.0))
        self.gconst = jtu.arrset(self.gconst,ig_['C5'],float(-4.0))
        self.gconst = jtu.arrset(self.gconst,ig_['C6'],float(34.0))
        self.gconst = jtu.arrset(self.gconst,ig_['C7'],float(8.0))
        self.gconst = jtu.arrset(self.gconst,ig_['C8'],float(768.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        if('X2' in ix_):
            ...
            self.y0  = (                   jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X2']),float(3.0)))
        if('X3' in ix_):
        ...
        if('X4' in ix_):
            self.x0 = jtu.np_like_set(self.x0, ix_['X4'], float(5.0))
        else:
            self.y0  = (                   jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X4']),float(5.0)))
        if('X5' in ix_):
        ...
        if('X6' in ix_):
            self.x0 = jtu.np_like_set(self.x0, ix_['X6'], float(2.0))
        else:
            self.y0  = (                   jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X6']),float(2.0)))
        if('X7' in ix_):
        ...
        if('X8' in ix_):
            self.x0 = jtu.np_like_set(self.x0, ix_['X8'], float(3.0))
        else:
            self.y0  = (                   jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X8']),float(3.0)))
        if('X9' in ix_):
            self.x0 = jtu.np_like_set(self.x0, ix_['X9'], float(6.0))
        else:
            self.y0  = (                   jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X9']),float(6.0)))
        if('X10' in ix_):
        ...
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['OE7'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(5.0))
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['OE8'])
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(7.0))
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['OE9'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(2.0))
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['OE10'])
        self.grelw = jtu.loaset(self.grelw,ig,posel, 1.)
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['OE11'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
        ig = ig_['C4']
        posel = len(self.grelt[ig])
