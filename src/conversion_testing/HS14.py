...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        [it,iet_,_] = jtu.s2mpj_ii( 'eSQm2', iet_)
        elftv = jtu.loaset(elftv,it,0,'V1')
        ...
        self.elftype = jtu.arrset(self.elftype,ie,'eSQm2')
        ielftype = jtu.arrset(ielftype,ie,iet_["eSQm2"])
        vname = 'X1'
    ...
    def eSQm2(self, nargout,*args):
        ...
        if nargout>1:
            try:
                ...
                dim = len(EV_)
            g_ = jnp.zeros(dim)
            g_ = jtu.np_like_set(g_, 0, 2.0*(V1M2))
            if nargout>2:
                H_ = jnp.zeros((1,1))
