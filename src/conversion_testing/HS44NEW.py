...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['CON1'],float(-8.0))
        self.gconst = jtu.arrset(self.gconst,ig_['CON2'],float(-12.0))
        self.gconst = jtu.arrset(self.gconst,ig_['CON3'],float(-12.0))
        self.gconst = jtu.arrset(self.gconst,ig_['CON4'],float(-8.0))
        self.gconst = jtu.arrset(self.gconst,ig_['CON5'],float(-8.0))
        self.gconst = jtu.arrset(self.gconst,ig_['CON6'],float(-5.0))
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
