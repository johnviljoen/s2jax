...
# IE N                   99997          $-PARAMETER
        ...
        for K in range(int(v_['1']),int(v_['NC'])+1):
            self.gconst = jtu.arrset(self.gconst,ig_['C'+str(K)],float(6.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        for I in range(int(v_['1']),int(v_['N'])+1,int(v_['4'])):
            self.x0 = jtu.np_like_set(self.x0, ix_['X'+str(I)], float(35.0))
        for I in range(int(v_['2']),int(v_['N'])+1,int(v_['4'])):
            self.x0 = jtu.np_like_set(self.x0, ix_['X'+str(I)], float(11.0))
