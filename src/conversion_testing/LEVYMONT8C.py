...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        pb.xlower = jnp.full((pb.n,1),-10.0e0)
        pb.xupper = jnp.full((pb.n,1),10.0e0)
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        pb.x0 = jnp.full((pb.n,1),float(8.0e0))
        pb.x0 = jtu.np_like_set(pb.x0, ix_['X1'], float(-8.0e0))
        pb.x0 = jtu.np_like_set(pb.x0, ix_['X2'], float(8.0e0))
        pass
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
        ...
        [iv,ix_,pb] = jtu.s2mpj_nlx(vname,ix_,pb,1,-10.0e0,10.0e0,8.0e0)
