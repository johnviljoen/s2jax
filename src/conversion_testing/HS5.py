...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.xlower = jtu.np_like_set(self.xlower, ix_['X1'], -1.5)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X1'], 4.0)
        self.xlower = jtu.np_like_set(self.xlower, ix_['X2'], -3.0)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X2'], 3.0)
        #%%%%%%%%%%%%%%%%%%%%% GRFTYPE %%%%%%%%%%%%%%%%%%%%
        igt_ = {}
