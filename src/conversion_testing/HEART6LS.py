...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['G1'],float(v_['sumuA']))
        self.gconst = jtu.arrset(self.gconst,ig_['G2'],float(v_['sumuB']))
        self.gconst = jtu.arrset(self.gconst,ig_['G3'],float(v_['sumuC']))
        self.gconst = jtu.arrset(self.gconst,ig_['G4'],float(v_['sumuD']))
        self.gconst = jtu.arrset(self.gconst,ig_['G5'],float(v_['sumuE']))
        self.gconst = jtu.arrset(self.gconst,ig_['G6'],float(v_['sumuF']))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        ename = 'E2'
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        self.elftype = jtu.arrset(self.elftype,ie,'eVPV')
        ielftype = jtu.arrset(ielftype,ie,iet_["eVPV"])
        vname = 'u'
        [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,None,None,float(1.0))
        posev = jnp.where(elftv[ielftype[ie]]=='X')[0]
        self.elvar = jtu.loaset(self.elvar,ie,posev[0],iv)
        ...
        posev = jnp.where(elftv[ielftype[ie]]=='Y')[0]
        self.elvar = jtu.loaset(self.elvar,ie,posev[0],iv)
        posep = jnp.where(elftp[ielftype[ie]]=='ALPHA')[0]
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(v_['sumuMx']))
        ename = 'E3'
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        self.elftype = jtu.arrset(self.elftype,ie,'en2PROD')
        ielftype = jtu.arrset(ielftype,ie,iet_["en2PROD"])
        ...
        self.elvar = jtu.loaset(self.elvar,ie,posev[0],iv)
        posep = jnp.where(elftp[ielftype[ie]]=='ALPHA')[0]
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(v_['sumuMy']))
        ename = 'E5'
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        self.elftype = jtu.arrset(self.elftype,ie,'en2PROD')
        ielftype = jtu.arrset(ielftype,ie,iet_["en2PROD"])
        ...
        ename = 'E11'
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        self.elftype = jtu.arrset(self.elftype,ie,'ePDFSQ')
        ielftype = jtu.arrset(ielftype,ie,iet_["ePDFSQ"])
        vname = 'a'
        [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,None,None,float(1.0))
        posev = jnp.where(elftv[ielftype[ie]]=='X')[0]
        self.elvar = jtu.loaset(self.elvar,ie,posev[0],iv)
        ...
        ename = 'E12'
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        self.elftype = jtu.arrset(self.elftype,ie,'eP3PRD')
        ielftype = jtu.arrset(ielftype,ie,iet_["eP3PRD"])
        vname = 'c'
        [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,None,None,float(1.0))
        posev = jnp.where(elftv[ielftype[ie]]=='X')[0]
        self.elvar = jtu.loaset(self.elvar,ie,posev[0],iv)
        ...
        ename = 'E19'
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        self.elftype = jtu.arrset(self.elftype,ie,'eD3PRD')
        ielftype = jtu.arrset(ielftype,ie,iet_["eD3PRD"])
        vname = 'a'
        [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,None,None,float(1.0))
        posev = jnp.where(elftv[ielftype[ie]]=='X')[0]
        self.elvar = jtu.loaset(self.elvar,ie,posev[0],iv)
