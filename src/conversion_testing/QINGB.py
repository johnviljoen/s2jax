...
# IE N                   5              $-PARAMETER
        ...
        for I in range(int(v_['1']),int(v_['M'])+1):
            v_['RI'] = float(I)
            self.gconst = jtu.arrset(self.gconst,ig_['F'+str(I)],float(v_['RI']))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xlower = jnp.full((self.n,1),-500.0)
        self.xupper = jnp.full((self.n,1),500.0)
        #%%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        ...
        for I in range(int(v_['1']),int(v_['M'])+1):
            ...
            vname = 'X'+str(I)
            [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,float(-500.0),float(500.0),None)
