...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        elftv = jtu.loaset(elftv,it,0,'EVAR')
        #%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
        ie_ = {}
        ...
        for I in range(int(v_['1']),int(v_['N'])+1):
            ...
            posev = jnp.where(elftv[ielftype[ie]]=='EVAR')[0]
        ...
        for I in range(int(v_['1']),int(v_['N-4'])+1):
            ...
            posel = posel+1
            self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['A'+str(int(v_['I+1']))])
            self.grelw = jtu.loaset(self.grelw,ig,posel,float(2.0))
            posel = len(self.grelt[ig])
            self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['A'+str(int(v_['I+2']))])
            self.grelw = jtu.loaset(self.grelw,ig,posel,float(3.0))
            posel = posel+1
            self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['A'+str(int(v_['I+3']))])
