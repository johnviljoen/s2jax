...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        cnames = jtu.arrset(cnames,ig,'G8')
        [ig,ig_,_] = jtu.s2mpj_ii('G9',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G9')
        [ig,ig_,_] = jtu.s2mpj_ii('G10',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G10')
        [ig,ig_,_] = jtu.s2mpj_ii('G11',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G11')
        [ig,ig_,_] = jtu.s2mpj_ii('G12',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G12')
        [ig,ig_,_] = jtu.s2mpj_ii('G13',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G13')
        [ig,ig_,_] = jtu.s2mpj_ii('G14',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G14')
        [ig,ig_,_] = jtu.s2mpj_ii('G15',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G15')
        [ig,ig_,_] = jtu.s2mpj_ii('G16',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G16')
        [ig,ig_,_] = jtu.s2mpj_ii('G18',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G18')
        [ig,ig_,_] = jtu.s2mpj_ii('G20',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G20')
        [ig,ig_,_] = jtu.s2mpj_ii('G25',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G25')
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        self.n   = len(ix_)
        ngrp   = len(ig_)
