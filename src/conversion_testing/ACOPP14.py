...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.xlower = jtu.np_like_set(self.xlower, ix_['M1'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M1'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M2'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M2'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M3'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M3'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M4'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M4'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M5'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M5'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M6'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M6'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M7'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M7'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M8'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M8'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M9'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M9'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M10'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M10'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M11'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M11'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M12'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M12'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M13'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M13'], 1.06)
        self.xlower = jtu.np_like_set(self.xlower, ix_['M14'], 0.94)
        self.xupper = jtu.np_like_set(self.xupper, ix_['M14'], 1.06)
        ...
        self.x0 = jtu.np_like_set(self.x0, ix_['M1'], float(1.06))
        self.x0 = jtu.np_like_set(self.x0, ix_['M2'], float(1.045))
        self.x0 = jtu.np_like_set(self.x0, ix_['M3'], float(1.01))
        self.x0 = jtu.np_like_set(self.x0, ix_['M4'], float(1.019))
        self.x0 = jtu.np_like_set(self.x0, ix_['M5'], float(1.02))
        self.x0 = jtu.np_like_set(self.x0, ix_['M6'], float(1.07))
        self.x0 = jtu.np_like_set(self.x0, ix_['M7'], float(1.062))
        self.x0 = jtu.np_like_set(self.x0, ix_['M8'], float(1.09))
        self.x0 = jtu.np_like_set(self.x0, ix_['M9'], float(1.056))
        self.x0 = jtu.np_like_set(self.x0, ix_['M10'], float(1.051))
        self.x0 = jtu.np_like_set(self.x0, ix_['M11'], float(1.057))
        self.x0 = jtu.np_like_set(self.x0, ix_['M12'], float(1.055))
        self.x0 = jtu.np_like_set(self.x0, ix_['M13'], float(1.05))
        self.x0 = jtu.np_like_set(self.x0, ix_['M14'], float(1.036))
        self.x0 = jtu.np_like_set(self.x0, ix_['A2'], float(-0.086917396))
        self.x0 = jtu.np_like_set(self.x0, ix_['A3'], float(-0.222005880))
        self.x0 = jtu.np_like_set(self.x0, ix_['A4'], float(-0.180292511))
        self.x0 = jtu.np_like_set(self.x0, ix_['A5'], float(-0.153239908))
        self.x0 = jtu.np_like_set(self.x0, ix_['A6'], float(-0.248185819))
        self.x0 = jtu.np_like_set(self.x0, ix_['A7'], float(-0.233350520))
        self.x0 = jtu.np_like_set(self.x0, ix_['A8'], float(-0.233175988))
        self.x0 = jtu.np_like_set(self.x0, ix_['A9'], float(-0.260752190))
        self.x0 = jtu.np_like_set(self.x0, ix_['A10'], float(-0.263544717))
        self.x0 = jtu.np_like_set(self.x0, ix_['A11'], float(-0.258134196))
        self.x0 = jtu.np_like_set(self.x0, ix_['A12'], float(-0.263021118))
        self.x0 = jtu.np_like_set(self.x0, ix_['A13'], float(-0.264591914))
        self.x0 = jtu.np_like_set(self.x0, ix_['A14'], float(-0.279950812))
