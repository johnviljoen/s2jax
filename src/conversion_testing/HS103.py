...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        for I in range(int(v_['1']),int(v_['M'])+1):
            [ig,ig_,_] = jtu.s2mpj_ii('CONSTR'+str(I),ig_)
            gtype = jtu.arrset(gtype,ig,'<=')
            cnames = jtu.arrset(cnames,ig,'CONSTR'+str(I))
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        self.n   = len(ix_)
        ngrp   = len(ig_)
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['CONSTR1'],float(1.0))
        self.gconst = jtu.arrset(self.gconst,ig_['CONSTR2'],float(1.0))
        self.gconst = jtu.arrset(self.gconst,ig_['CONSTR3'],float(1.0))
        self.gconst = jtu.arrset(self.gconst,ig_['CONSTR4'],float(1.0))
        self.gconst = jtu.arrset(self.gconst,ig_['CONSTR5'],float(3000.0))
        #%%%%%%%%%%%%%%%%%%%%  RANGES %%%%%%%%%%%%%%%%%%%%%%
        ...
        self.xlower = jtu.np_like_set(self.xlower, ix_['X7'], 0.01)
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        self.x0 = jnp.full((self.n,1),float(6.0))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
        ...
        [it,iet_,_] = jtu.s2mpj_ii( 'en6PR', iet_)
        elftv = jtu.loaset(elftv,it,0,'V1')
        elftv = jtu.loaset(elftv,it,1,'V2')
        elftv = jtu.loaset(elftv,it,2,'V3')
        elftv = jtu.loaset(elftv,it,3,'V4')
        ...
        elftp = jtu.loaset(elftp,it,2,'P2')
        elftp = jtu.loaset(elftp,it,3,'P3')
        elftp = jtu.loaset(elftp,it,4,'P4')
        elftp = jtu.loaset(elftp,it,5,'P5')
        #%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
        ie_ = {}
        ...
        vname = 'X1'
        [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,float(0.1),float(10.0),float(6.0))
        ...
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(-0.5))
        posep = jnp.where(elftp[ielftype[ie]]=='P4')[0]
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(0.66666666))
        posep = jnp.where(elftp[ielftype[ie]]=='P5')[0]
        ...
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(-1.0))
        posep = jnp.where(elftp[ielftype[ie]]=='P5')[0]
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(0.3333333333))
        ename = 'E1C3'
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        self.elftype = jtu.arrset(self.elftype,ie,'en5PR')
        ielftype = jtu.arrset(ielftype,ie,iet_["en5PR"])
        ...
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(1.0))
        posep = jnp.where(elftp[ielftype[ie]]=='P2')[0]
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(-1.5))
        posep = jnp.where(elftp[ielftype[ie]]=='P3')[0]
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(1.0))
        posep = jnp.where(elftp[ielftype[ie]]=='P4')[0]
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(-1.0))
        ...
        ename = 'E2C4'
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        self.elftype = jtu.arrset(self.elftype,ie,'en6PR')
        ielftype = jtu.arrset(ielftype,ie,iet_["en6PR"])
        vname = 'X1'
        [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,float(0.1),float(10.0),float(6.0))
        posev = jnp.where(elftv[ielftype[ie]]=='V1')[0]
        self.elvar = jtu.loaset(self.elvar,ie,posev[0],iv)
        ...
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(0.3333333333))
        posep = jnp.where(elftp[ielftype[ie]]=='P5')[0]
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(-0.666666666))
        ...
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(1.0))
        posep = jnp.where(elftp[ielftype[ie]]=='P5')[0]
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(0.75))
        ename = 'E4C4'
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        ...
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(-3.0))
        posep = jnp.where(elftp[ielftype[ie]]=='P5')[0]
        self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(v_['A101']))
        ename = 'E2C5'
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        self.elftype = jtu.arrset(self.elftype,ie,'en6PR')
        ielftype = jtu.arrset(ielftype,ie,iet_["en6PR"])
        ...
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E1C5'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(10.0))
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E2C5'])
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(15.0))
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E3C5'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(20.0))
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E4C5'])
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(25.0))
        ig = ig_['CONSTR1']
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E1C1'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(0.5))
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E2C1'])
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(0.7))
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E3C1'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(0.2))
        ig = ig_['CONSTR2']
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E1C2'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(1.3))
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E2C2'])
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(0.8))
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E3C2'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(3.1))
        ig = ig_['CONSTR3']
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E1C3'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(2.0))
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E2C3'])
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(0.1))
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E3C3'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E4C3'])
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(0.65))
        ig = ig_['CONSTR4']
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E1C4'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(0.2))
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E2C4'])
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(0.3))
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E3C4'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(0.4))
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E4C4'])
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(0.5))
        ig = ig_['CONSTR5']
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['E1C5'])
...
# **********************
    ...
    def en3PR(self, nargout,*args):
        ...
        if nargout>1:
            try:
                ...
                dim = len(EV_)
            g_ = jnp.zeros(dim)
            g_ = jtu.np_like_set(g_, 0, FVALUE*(self.elpar[iel_][0]/EV_[0]))
            g_ = jtu.np_like_set(g_, 1, FVALUE*(self.elpar[iel_][1]/EV_[1]))
            ...
            if nargout>2:
                ...
                H_ = jtu.np_like_set(H_, jnp.array([1,2]), FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][2]/EV_[2]))
    ...
    def en4PR(self, nargout,*args):
        ...
        if nargout>1:
            ...
            if nargout>2:
                ...
                H_ = jtu.np_like_set(H_, jnp.array([0,2]), FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][2]/EV_[2]))
                H_ = jtu.np_like_set(H_, jnp.array([2,0]), H_[0,2])
                H_ = jtu.np_like_set(H_, jnp.array([0,3]), FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][3]/EV_[3]))
                H_ = jtu.np_like_set(H_, jnp.array([3,0]), H_[0,3])
                H_ = jtu.np_like_set(H_, jnp.array([1,2]), FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][2]/EV_[2]))
                H_ = jtu.np_like_set(H_, jnp.array([2,1]), H_[1,2])
                H_ = jtu.np_like_set(H_, jnp.array([1,3]), FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][3]/EV_[3]))
                H_ = jtu.np_like_set(H_, jnp.array([3,1]), H_[1,3])
                H_ = jtu.np_like_set(H_, jnp.array([2,3]), FVALUE*(self.elpar[iel_][2]/EV_[2])*(self.elpar[iel_][3]/EV_[3]))
    ...
    def en5PR(self, nargout,*args):
        ...
        if nargout>1:
            ...
            if nargout>2:
                ...
                H_ = jtu.np_like_set(H_, jnp.array([0,3]), FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][3]/EV_[3]))
                H_ = jtu.np_like_set(H_, jnp.array([3,0]), H_[0,3])
                H_ = jtu.np_like_set(H_, jnp.array([0,4]), FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][4]/EV_[4]))
                H_ = jtu.np_like_set(H_, jnp.array([4,0]), H_[0,4])
                H_ = jtu.np_like_set(H_, jnp.array([1,2]), FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][2]/EV_[2]))
                H_ = jtu.np_like_set(H_, jnp.array([2,1]), H_[1,2])
                H_ = jtu.np_like_set(H_, jnp.array([1,3]), FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][3]/EV_[3]))
                H_ = jtu.np_like_set(H_, jnp.array([3,1]), H_[1,3])
                H_ = jtu.np_like_set(H_, jnp.array([1,4]), FVALUE*(self.elpar[iel_][1]/EV_[1])*(self.elpar[iel_][4]/EV_[4]))
                H_ = jtu.np_like_set(H_, jnp.array([4,1]), H_[1,4])
                H_ = jtu.np_like_set(H_, jnp.array([2,3]), FVALUE*(self.elpar[iel_][2]/EV_[2])*(self.elpar[iel_][3]/EV_[3]))
                H_ = jtu.np_like_set(H_, jnp.array([3,2]), H_[2,3])
                H_ = jtu.np_like_set(H_, jnp.array([2,4]), FVALUE*(self.elpar[iel_][2]/EV_[2])*(self.elpar[iel_][4]/EV_[4]))
                H_ = jtu.np_like_set(H_, jnp.array([4,2]), H_[2,4])
                H_ = jtu.np_like_set(H_, jnp.array([3,4]), FVALUE*(self.elpar[iel_][3]/EV_[3])*(self.elpar[iel_][4]/EV_[4]))
    ...
    def en6PR(self, nargout,*args):
        ...
        if nargout>1:
            ...
            g_ = jnp.zeros(dim)
            g_ = jtu.np_like_set(g_, 0, FVALUE*(self.elpar[iel_][0]/EV_[0]))
            g_ = jtu.np_like_set(g_, 1, FVALUE*(self.elpar[iel_][2]/EV_[1]))
            g_ = jtu.np_like_set(g_, 2, FVALUE*(self.elpar[iel_][3]/EV_[2]))
            g_ = jtu.np_like_set(g_, 3, FVALUE*(self.elpar[iel_][4]/EV_[3]))
            g_ = jtu.np_like_set(g_, 4, FVALUE*(self.elpar[iel_][5]/EV_[4]))
            ...
            if nargout>2:
                ...
                H_ = jtu.np_like_set(H_, jnp.array([2,0]), H_[0,2])
                H_ = jtu.np_like_set(H_, jnp.array([0,3]), FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][4]/EV_[3]))
                H_ = jtu.np_like_set(H_, jnp.array([3,0]), H_[0,3])
                H_ = jtu.np_like_set(H_, jnp.array([0,4]), FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][5]/EV_[4]))
                H_ = jtu.np_like_set(H_, jnp.array([4,0]), H_[0,4])
                H_ = jtu.np_like_set(H_, jnp.array([0,5]), FVALUE*(self.elpar[iel_][0]/EV_[0])*(self.elpar[iel_][1]/EV_[5]))
                H_ = jtu.np_like_set(H_, jnp.array([5,0]), H_[0,5])
                H_ = jtu.np_like_set(H_, jnp.array([1,2]), FVALUE*(self.elpar[iel_][2]/EV_[1])*(self.elpar[iel_][3]/EV_[2]))
                H_ = jtu.np_like_set(H_, jnp.array([2,1]), H_[1,2])
                H_ = jtu.np_like_set(H_, jnp.array([1,3]), FVALUE*(self.elpar[iel_][2]/EV_[1])*(self.elpar[iel_][4]/EV_[3]))
                H_ = jtu.np_like_set(H_, jnp.array([3,1]), H_[1,3])
                H_ = jtu.np_like_set(H_, jnp.array([1,4]), FVALUE*(self.elpar[iel_][2]/EV_[1])*(self.elpar[iel_][5]/EV_[4]))
                H_ = jtu.np_like_set(H_, jnp.array([4,1]), H_[1,4])
                H_ = jtu.np_like_set(H_, jnp.array([1,5]), FVALUE*(self.elpar[iel_][2]/EV_[1])*(self.elpar[iel_][1]/EV_[5]))
                H_ = jtu.np_like_set(H_, jnp.array([5,1]), H_[1,5])
                H_ = jtu.np_like_set(H_, jnp.array([2,3]), FVALUE*(self.elpar[iel_][3]/EV_[2])*(self.elpar[iel_][4]/EV_[3]))
                H_ = jtu.np_like_set(H_, jnp.array([3,2]), H_[2,3])
                H_ = jtu.np_like_set(H_, jnp.array([2,4]), FVALUE*(self.elpar[iel_][3]/EV_[2])*(self.elpar[iel_][5]/EV_[4]))
                H_ = jtu.np_like_set(H_, jnp.array([4,2]), H_[2,4])
                H_ = jtu.np_like_set(H_, jnp.array([2,5]), FVALUE*(self.elpar[iel_][3]/EV_[2])*(self.elpar[iel_][1]/EV_[5]))
                H_ = jtu.np_like_set(H_, jnp.array([5,2]), H_[2,5])
                H_ = jtu.np_like_set(H_, jnp.array([3,4]), FVALUE*(self.elpar[iel_][4]/EV_[3])*(self.elpar[iel_][5]/EV_[4]))
                H_ = jtu.np_like_set(H_, jnp.array([4,3]), H_[3,4])
                H_ = jtu.np_like_set(H_, jnp.array([3,5]), FVALUE*(self.elpar[iel_][4]/EV_[3])*(self.elpar[iel_][1]/EV_[5]))
                H_ = jtu.np_like_set(H_, jnp.array([5,3]), H_[3,5])
                H_ = jtu.np_like_set(H_, jnp.array([4,5]), FVALUE*(self.elpar[iel_][5]/EV_[4])*(self.elpar[iel_][1]/EV_[5]))
