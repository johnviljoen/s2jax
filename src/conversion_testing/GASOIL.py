...
# IE NH                  400            $-PARAMETER
        ...
        for I in range(int(v_['1']),int(v_['NM'])+1):
            ...
            v_['ABSA'] = int(jnp.fix(v_['ABSA']))
            v_['B'] = float(v_['B'])
            v_['ABSB'] = jnp.absolute(v_['B'])
            v_['ABSB'] = int(jnp.fix(v_['ABSB']))
            v_['ABSA+B'] = v_['ABSA']+v_['ABSB']
            v_['A'] = v_['A']+v_['ABSA+B']
            v_['B'] = v_['B']+v_['ABSA+B']
            v_['A/B'] = int(jnp.fix(v_['A']/v_['B']))
            v_['B/A'] = int(jnp.fix(v_['B']/v_['A']))
            v_['SUM'] = v_['A/B']+v_['B/A']
            v_['A'] = v_['A']*v_['A/B']
            v_['B'] = v_['B']*v_['B/A']
            v_['MAXA,B'] = v_['A']+v_['B']
            v_['MAXA,B'] = int(jnp.fix(v_['MAXA,B']/v_['SUM']))
        ...
        for I in range(int(v_['1']),int(v_['NH'])+1):
            ...
            for K in range(int(v_['1']),int(v_['NC'])+1):
                for S in range(int(v_['1']),int(v_['NE'])+1):
                    [iv,ix_,_] = jtu.s2mpj_ii('W'+str(I)+','+str(K)+','+str(S),ix_)
                    self.xnames=jtu.arrset(self.xnames,iv,'W'+str(I)+','+str(K)+','+str(S))
            for J in range(int(v_['1']),int(v_['NC'])+1):
                for S in range(int(v_['1']),int(v_['NE'])+1):
                    [iv,ix_,_] = jtu.s2mpj_ii('U'+str(I)+','+str(J)+','+str(S),ix_)
                    self.xnames=jtu.arrset(self.xnames,iv,'U'+str(I)+','+str(J)+','+str(S))
                    [iv,ix_,_] = jtu.s2mpj_ii('DU'+str(I)+','+str(J)+','+str(S),ix_)
                    self.xnames=jtu.arrset(self.xnames,iv,'DU'+str(I)+','+str(J)+','+str(S))
        #%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        ...
        for J in range(int(v_['1']),int(v_['NM'])+1):
            ...
            v_['I'] = int(jnp.fix(v_['RITAU']))
            v_['T'] = -1.0+v_['RITAU']
            v_['T'] = v_['T']*v_['H']
            v_['DIFF'] = v_['TAU'+str(J)]-v_['T']
            for S in range(int(v_['1']),int(v_['NE'])+1):
                v_['RATIO'] = v_['DIFF']
                [ig,ig_,_] = jtu.s2mpj_ii('OBJ'+str(J)+','+str(S),ig_)
                gtype = jtu.arrset(gtype,ig,'<>')
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['V'+str(int(v_['I']))+','+str(S)]])
                ...
                for K in range(int(v_['1']),int(v_['NC'])+1):
                    ...
                    gtype = jtu.arrset(gtype,ig,'<>')
                    irA  = jtu.append(irA,[ig])
                    icA  = jtu.append(icA,[ix_['W'+str(int(v_['I']))+','+str(K)+','+str(S)]])
                    valA = jtu.append(valA,float(v_['COEF']))
                    v_['RATIO'] = v_['RATIO']*v_['DIFF']
                    v_['RATIO'] = v_['RATIO']/v_['H']
        for I in range(int(v_['1']),int(v_['NH'])+1):
            for J in range(int(v_['1']),int(v_['NC'])+1):
                v_['RH'] = v_['RHO'+str(J)]
                [ig,ig_,_] = jtu.s2mpj_ii('U'+str(I)+','+str(J)+','+str(int(v_['1'])),ig_)
                gtype = jtu.arrset(gtype,ig,'==')
                cnames = jtu.arrset(cnames,ig,'U'+str(I)+','+str(J)+','+str(int(v_['1'])))
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['U'+str(I)+','+str(J)+','+str(int(v_['1']))]])
                valA = jtu.append(valA,float(-1.0))
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['V'+str(I)+','+str(int(v_['1']))]])
                valA = jtu.append(valA,float(1.0))
                [ig,ig_,_] = jtu.s2mpj_ii('U'+str(I)+','+str(J)+','+str(int(v_['2'])),ig_)
                gtype = jtu.arrset(gtype,ig,'==')
                cnames = jtu.arrset(cnames,ig,'U'+str(I)+','+str(J)+','+str(int(v_['2'])))
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['U'+str(I)+','+str(J)+','+str(int(v_['2']))]])
                valA = jtu.append(valA,float(-1.0))
                irA  = jtu.append(irA,[ig])
                ...
                for K in range(int(v_['1']),int(v_['NC'])+1):
                    ...
                    cnames = jtu.arrset(cnames,ig,'U'+str(I)+','+str(J)+','+str(int(v_['1'])))
                    irA  = jtu.append(irA,[ig])
                    icA  = jtu.append(icA,[ix_['W'+str(I)+','+str(K)+','+str(int(v_['1']))]])
                    valA = jtu.append(valA,float(v_['COEF']))
                    [ig,ig_,_] = jtu.s2mpj_ii('U'+str(I)+','+str(J)+','+str(int(v_['2'])),ig_)
                    gtype = jtu.arrset(gtype,ig,'==')
                    cnames = jtu.arrset(cnames,ig,'U'+str(I)+','+str(J)+','+str(int(v_['2'])))
                    irA  = jtu.append(irA,[ig])
                    icA  = jtu.append(icA,[ix_['W'+str(I)+','+str(K)+','+str(int(v_['2']))]])
                    valA = jtu.append(valA,float(v_['COEF']))
                    v_['PROD'] = v_['PROD']*v_['RH']
                [ig,ig_,_] = jtu.s2mpj_ii('DU'+str(I)+','+str(J)+','+str(int(v_['1'])),ig_)
                gtype = jtu.arrset(gtype,ig,'==')
                cnames = jtu.arrset(cnames,ig,'DU'+str(I)+','+str(J)+','+str(int(v_['1'])))
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['DU'+str(I)+','+str(J)+','+str(int(v_['1']))]])
                valA = jtu.append(valA,float(-1.0))
                [ig,ig_,_] = jtu.s2mpj_ii('DU'+str(I)+','+str(J)+','+str(int(v_['2'])),ig_)
                gtype = jtu.arrset(gtype,ig,'==')
                cnames = jtu.arrset(cnames,ig,'DU'+str(I)+','+str(J)+','+str(int(v_['2'])))
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['DU'+str(I)+','+str(J)+','+str(int(v_['2']))]])
                valA = jtu.append(valA,float(-1.0))
                v_['PROD'] = 1.0
                for K in range(int(v_['1']),int(v_['NC'])+1):
                    v_['K-1'] = -1+K
        ...
        for I in range(int(v_['1']),int(v_['NH-1'])+1):
            v_['I+1'] = 1+I
            for S in range(int(v_['1']),int(v_['NE'])+1):
                [ig,ig_,_] = jtu.s2mpj_ii('C'+str(I)+','+str(S),ig_)
                gtype = jtu.arrset(gtype,ig,'==')
                cnames = jtu.arrset(cnames,ig,'C'+str(I)+','+str(S))
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['V'+str(I)+','+str(S)]])
                valA = jtu.append(valA,float(1.0))
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['V'+str(int(v_['I+1']))+','+str(S)]])
                valA = jtu.append(valA,float(-1.0))
                for J in range(int(v_['1']),int(v_['NC'])+1):
                    ...
                    cnames = jtu.arrset(cnames,ig,'C'+str(I)+','+str(S))
                    irA  = jtu.append(irA,[ig])
                    icA  = jtu.append(icA,[ix_['W'+str(I)+','+str(J)+','+str(S)]])
                    valA = jtu.append(valA,float(v_['COEF']))
        for I in range(int(v_['1']),int(v_['NH'])+1):
            for J in range(int(v_['1']),int(v_['NC'])+1):
                for S in range(int(v_['1']),int(v_['NE'])+1):
                    [ig,ig_,_] = jtu.s2mpj_ii('CO'+str(I)+','+str(J)+','+str(S),ig_)
                    gtype = jtu.arrset(gtype,ig,'==')
                    cnames = jtu.arrset(cnames,ig,'CO'+str(I)+','+str(J)+','+str(S))
                    irA  = jtu.append(irA,[ig])
                    icA  = jtu.append(icA,[ix_['DU'+str(I)+','+str(J)+','+str(S)]])
                    valA = jtu.append(valA,float(1.0))
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        self.n   = len(ix_)
        ngrp   = len(ig_)
        ...
        for I in range(int(v_['1']),int(v_['NP'])+1):
            self.xlower = jtu.np_like_set(self.xlower, ix_['THETA'+str(I)], 0.0)
        for S in range(int(v_['1']),int(v_['NE'])+1):
            self.xlower = jtu.np_like_set(self.xlower, jnp.array([ix_['V'+str(int(v_['1']))+','+str(S)]]), v_['BC'+str(S)])
            self.xupper = jtu.np_like_set(self.xupper, jnp.array([ix_['V'+str(int(v_['1']))+','+str(S)]]), v_['BC'+str(S)])
        #%%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        ...
        elftv = jtu.loaset(elftv,it,0,'THETA1')
        elftv = jtu.loaset(elftv,it,1,'THETA3')
        elftv = jtu.loaset(elftv,it,2,'U')
        [it,iet_,_] = jtu.s2mpj_ii( 'ePROD2', iet_)
        elftv = jtu.loaset(elftv,it,0,'THETA')
        elftv = jtu.loaset(elftv,it,1,'U')
        [it,iet_,_] = jtu.s2mpj_ii( 'ePROD3', iet_)
        elftv = jtu.loaset(elftv,it,0,'THETA')
        elftv = jtu.loaset(elftv,it,1,'U')
        #%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
        ie_ = {}
        ...
        for I in range(int(v_['1']),int(v_['NH'])+1):
            for J in range(int(v_['1']),int(v_['NC'])+1):
                ...
                posev = jnp.where(elftv[ielftype[ie]]=='THETA1')[0]
                self.elvar = jtu.loaset(self.elvar,ie,posev[0],iv)
                vname = 'THETA'+str(int(v_['3']))
                [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,None,None,None)
                posev = jnp.where(elftv[ielftype[ie]]=='THETA3')[0]
                self.elvar = jtu.loaset(self.elvar,ie,posev[0],iv)
                ...
                vname = 'THETA'+str(int(v_['1']))
                [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,None,None,None)
                posev = jnp.where(elftv[ielftype[ie]]=='THETA')[0]
                self.elvar = jtu.loaset(self.elvar,ie,posev[0],iv)
                vname = 'U'+str(I)+','+str(J)+','+str(int(v_['1']))
                [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,None,None,None)
                posev = jnp.where(elftv[ielftype[ie]]=='U')[0]
                ...
                [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
                self.elftype = jtu.arrset(self.elftype,ie,'ePROD3')
                ielftype = jtu.arrset(ielftype,ie,iet_["ePROD3"])
        ...
        for I in range(int(v_['1']),int(v_['NH'])+1):
            for J in range(int(v_['1']),int(v_['NC'])+1):
                ...
                self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['P1'+str(I)+','+str(J)])
                nlc = jnp.union1d(nlc,jnp.array([ig]))
                self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
                ig = ig_['CO'+str(I)+','+str(J)+','+str(int(v_['2']))]
                posel = len(self.grelt[ig])
                self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['P2'+str(I)+','+str(J)])
                nlc = jnp.union1d(nlc,jnp.array([ig]))
                self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
                posel = posel+1
                self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['P3'+str(I)+','+str(J)])
                self.grelw = jtu.loaset(self.grelw,ig,posel, 1.)
        for J in range(int(v_['1']),int(v_['NM'])+1):
            for S in range(int(v_['1']),int(v_['NE'])+1):
