...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'G'+str(int(v_['N'])))
        irA  = jtu.append(irA,[ig])
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['G'+str(int(v_['1']))],float(1.0))
        self.gconst = jtu.arrset(self.gconst,ig_['G'+str(int(v_['N']))],float(1.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xupper = jnp.full((self.n,1),10.0)
        self.xlower = jnp.zeros((self.n,1))
        self.xlower = jtu.np_like_set(self.xlower, ix_['X'+str(int(v_['N']))], -float('Inf'))
        self.xupper = jtu.np_like_set(self.xupper, ix_['X'+str(int(v_['N']))], +float('Inf'))
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        self.x0 = jnp.full((self.n,1),float(0.9))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
        ...
        for I in range(int(v_['2']),int(v_['N-1'])+1):
            ...
            vname = 'X'+str(I)
            [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,None,float(10.0),float(0.9))
