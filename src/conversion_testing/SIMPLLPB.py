...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        [ig,ig_,_] = jtu.s2mpj_ii('CONSTR3',ig_)
        gtype = jtu.arrset(gtype,ig,'>=')
        cnames = jtu.arrset(cnames,ig,'CONSTR3')
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['X1']])
        valA = jtu.append(valA,float(2.0))
        irA  = jtu.append(irA,[ig])
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['CONSTR2'],float(1.2))
        self.gconst = jtu.arrset(self.gconst,ig_['CONSTR3'],float(1.2))
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
