...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.xupper = jtu.np_like_set(self.xupper, ix_['X'+str(int(v_['1']))], -1.0)
        self.xlower = jtu.arrset(self.xlower,ix_['X'+str(int(v_['1']))],-float('Inf'))
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
