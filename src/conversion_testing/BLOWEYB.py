...
# IE N                   8000           $-PARAMETER  n = 16002, m = 8002
        ...
        v_['2N**2'] = 2.0*v_['N**2']
        v_['-2N**2'] = -2.0*v_['N**2']
        v_['N/10'] = int(jnp.fix(v_['N']/v_['10']))
        ...
        for I in range(int(v_['0']),int(v_['N'])+1):
            ...
            valA = jtu.append(valA,float(v_['VAL']))
        ...
        gtype = jtu.arrset(gtype,ig,'<>')
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['U'+str(int(v_['0']))]])
        valA = jtu.append(valA,float(v_['VAL']))
        ...
        valA = jtu.append(valA,float(v_['VAL']))
        [ig,ig_,_] = jtu.s2mpj_ii('INT',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'INT')
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['U'+str(int(v_['0']))]])
        valA = jtu.append(valA,float(0.5))
        [ig,ig_,_] = jtu.s2mpj_ii('CON'+str(int(v_['0'])),ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'CON'+str(int(v_['0'])))
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['U'+str(int(v_['0']))]])
        ...
        valA = jtu.append(valA,float(v_['-1/N**2']))
        for I in range(int(v_['1']),int(v_['N-1'])+1):
            v_['I+1'] = 1+I
            v_['I-1'] = -1+I
            ...
            icA  = jtu.append(icA,[ix_['U'+str(I)]])
            valA = jtu.append(valA,float(1.0))
        [ig,ig_,_] = jtu.s2mpj_ii('CON'+str(int(v_['N'])),ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'CON'+str(int(v_['N'])))
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['U'+str(int(v_['N']))]])
        valA = jtu.append(valA,float(1.0))
        irA  = jtu.append(irA,[ig])
        ...
        cnames = jtu.arrset(cnames,ig,'CON'+str(int(v_['N'])))
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['W'+str(int(v_['N']))]])
        valA = jtu.append(valA,float(v_['-1/N**2']))
        [ig,ig_,_] = jtu.s2mpj_ii('INT',ig_)
        gtype = jtu.arrset(gtype,ig,'==')
        cnames = jtu.arrset(cnames,ig,'INT')
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['INT'],float(v_['INT']))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        for I in range(int(v_['0']),int(v_['N'])+1):
            self.x0 = jtu.np_like_set(self.x0, ix_['U'+str(I)], float(v_['V'+str(I)]))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
        ...
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['O'+str(int(v_['0']))])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(v_['-TWO']))
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['D'+str(int(v_['0']))])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(v_['ONE']))
        for I in range(int(v_['1']),int(v_['N-1'])+1):
            ig = ig_['OBJ']
            posel = len(self.grelt[ig])
        ...
        ig = ig_['OBJ']
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['D'+str(int(v_['N']))])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(v_['ONE']))
        for I in range(int(v_['0']),int(v_['N'])+1):
            ig = ig_['OBJ']
            ...
            nlc = jnp.union1d(nlc,jnp.array([ig]))
            self.grelw = jtu.loaset(self.grelw,ig,posel,float(v_['1/N**2']))
        #%%%%%%%%%%%%%%%%%% OBJECT BOUNDS %%%%%%%%%%%%%%%%%
#    Solution
