...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['CON2'],float(-10.0))
        self.gconst = jtu.arrset(self.gconst,ig_['CON3'],float(-5.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        iet_  = {}
        elftv = []
        [it,iet_,_] = jtu.s2mpj_ii( 'ePSQ', iet_)
        ...
        for I in range(int(v_['1']),int(v_['N'])+1):
            ...
            self.elftype = jtu.arrset(self.elftype,ie,'ePSQ')
            ielftype = jtu.arrset(ielftype,ie,iet_["ePSQ"])
            ...
            self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(v_['FAC'+str(I)]))
        for I in range(int(v_['1']),int(v_['N'])+1):
            v_['J'] = 4+I
