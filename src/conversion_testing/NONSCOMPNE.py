...
# IE N                   10000          $-PARAMETER
        ...
        cnames = jtu.arrset(cnames,ig,'SQ'+str(int(v_['1'])))
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['SQ'+str(int(v_['1']))],float(1.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        for I in range(int(v_['1']),int(v_['N'])+1):
            if('X'+str(I) in ix_):
                ...
                self.y0  = (                       jtu.arrset(self.y0,findfirst(self.congrps,lambda x:x==ig_['X'+str(I)]),float(3.0)))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
