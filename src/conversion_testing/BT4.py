...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.x0 = jtu.np_like_set(self.x0, ix_['X1'], float(4.0382))
        self.x0 = jtu.np_like_set(self.x0, ix_['X2'], float(-2.9470))
        self.x0 = jtu.np_like_set(self.x0, ix_['X3'], float(-0.09115))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
