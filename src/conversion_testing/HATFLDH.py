...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['C1'],float(2.5))
        self.gconst = jtu.arrset(self.gconst,ig_['C2'],float(2.5))
        self.gconst = jtu.arrset(self.gconst,ig_['C3'],float(2.5))
        self.gconst = jtu.arrset(self.gconst,ig_['C4'],float(2.0))
        self.gconst = jtu.arrset(self.gconst,ig_['C5'],float(2.0))
        self.gconst = jtu.arrset(self.gconst,ig_['C6'],float(1.5))
        self.gconst = jtu.arrset(self.gconst,ig_['C7'],float(5.0))
        #%%%%%%%%%%%%%%%%%%%%  RANGES %%%%%%%%%%%%%%%%%%%%%%
        grange = jnp.full((ngrp,1),None)
        grange = jtu.np_like_set(grange, gegrps, jnp.full((self.nge,1),float('inf')))
        grange = jtu.arrset(grange,ig_['C1'],float(5.0))
        grange = jtu.arrset(grange,ig_['C2'],float(5.0))
        grange = jtu.arrset(grange,ig_['C3'],float(5.0))
        grange = jtu.arrset(grange,ig_['C4'],float(5.0))
        grange = jtu.arrset(grange,ig_['C5'],float(5.0))
        grange = jtu.arrset(grange,ig_['C6'],float(5.0))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xupper = jnp.full((self.n,1),5.0)
        ...
        vname = 'X1'
        [iv,ix_] = jtu.s2mpj_nlx(self,vname,ix_,1,None,float(5.0),None)
        ...
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['A1'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(-1.0))
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['A2'])
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(-1.0))
        #%%%%%%%%%%%%%%%%%% OBJECT BOUNDS %%%%%%%%%%%%%%%%%
#    Solution
# LO SOLTN               -24.4999998
