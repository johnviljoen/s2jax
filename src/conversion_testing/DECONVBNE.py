...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        for K in range(int(v_['1']),int(v_['LGTR'])+1):
            ...
            cnames = jtu.arrset(cnames,ig,'R'+str(K))
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        self.n   = len(ix_)
        ngrp   = len(ig_)
        ...
        for I in range(int(v_['1']),int(v_['LGSG'])+1):
            self.xlower = jtu.np_like_set(self.xlower, ix_['SG'+str(I)], 0.0)
            self.xupper = jtu.np_like_set(self.xupper, ix_['SG'+str(I)], v_['PIC'])
