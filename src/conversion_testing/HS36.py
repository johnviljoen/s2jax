...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['CON1'],float(-72.0))
        #%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xlower = jnp.zeros((self.n,1))
        self.xupper = jnp.full((self.n,1),float('inf'))
        self.xupper = jtu.np_like_set(self.xupper, ix_['X1'], 20.0)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X2'], 11.0)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X3'], 42.0)
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
...
# **********************
    ...
    def ePROD3(self, nargout,*args):
        ...
        if nargout>1:
            ...
            g_ = jtu.np_like_set(g_, 2, -EV_[1]*EV_[0])
            if nargout>2:
                H_ = jnp.zeros((3,3))
