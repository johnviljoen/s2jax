...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        gtype = jtu.arrset(gtype,ig,'<>')
        self.gscale = jtu.arrset(self.gscale,ig,float(v_['1/P1']))
        ...
        valA = jtu.append(valA,float(1.0))
        self.gscale = jtu.arrset(self.gscale,ig,float(v_['1/P2']))
        ...
        self.y0 = jtu.arrset(self.x0,ix_['X2'],float(-1.0))
        self.x0 = jtu.np_like_set(self.x0, ix_['X3'], float(-3.0))
        self.y0 = jtu.arrset(self.x0,ix_['X4'],float(-1.0))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
        ...
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(19.8))
        #%%%%%%%%%%%%%%%%%% OBJECT BOUNDS %%%%%%%%%%%%%%%%%
        self.objlower = -99.0
#    Solution
# LO SOLTN               0.0
    ...
    def ePROD(self, nargout,*args):
        ...
        if nargout>1:
            try:
                ...
                dim = len(EV_)
            g_ = jnp.zeros(dim)
            g_ = jtu.np_like_set(g_, 0, -M4)
            g_ = jtu.np_like_set(g_, 1, -M2)
            if nargout>2:
                H_ = jnp.zeros((2,2))
