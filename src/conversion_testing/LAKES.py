    ...
    def __init__(self, *args): 
        ...
        for I in range(int(v_['1']),int(v_['N'])+1):
            for J in range(int(v_['1']),int(v_['5'])+1):
                ...
                [iv,ix_,_] = jtu.s2mpj_ii('O'+str(I)+','+str(J),ix_)
                self.xnames=jtu.arrset(self.xnames,iv,'O'+str(I)+','+str(J))
            [iv,ix_,_] = jtu.s2mpj_ii('V'+str(I)+','+str(int(v_['2'])),ix_)
            self.xnames=jtu.arrset(self.xnames,iv,'V'+str(I)+','+str(int(v_['2'])))
            [iv,ix_,_] = jtu.s2mpj_ii('W'+str(I)+','+str(int(v_['2'])),ix_)
            self.xnames=jtu.arrset(self.xnames,iv,'W'+str(I)+','+str(int(v_['2'])))
            [iv,ix_,_] = jtu.s2mpj_ii('V'+str(I)+','+str(int(v_['3'])),ix_)
            self.xnames=jtu.arrset(self.xnames,iv,'V'+str(I)+','+str(int(v_['3'])))
            [iv,ix_,_] = jtu.s2mpj_ii('W'+str(I)+','+str(int(v_['3'])),ix_)
            self.xnames=jtu.arrset(self.xnames,iv,'W'+str(I)+','+str(int(v_['3'])))
            [iv,ix_,_] = jtu.s2mpj_ii('V'+str(I)+','+str(int(v_['4'])),ix_)
            self.xnames=jtu.arrset(self.xnames,iv,'V'+str(I)+','+str(int(v_['4'])))
        #%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        ...
        for i in range(int(v_['1']),int(v_['N'])+1):
            v_['n+i'] = v_['N']+i
            for j in range(int(v_['1']),int(v_['5'])+1):
                [ig,ig_,_] = jtu.s2mpj_ii('R'+str(i)+','+str(j),ig_)
                gtype = jtu.arrset(gtype,ig,'<>')
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['T'+str(i)+','+str(j)]])
                valA = jtu.append(valA,float(1.0))
                [ig,ig_,_] = jtu.s2mpj_ii('R'+str(int(v_['n+i']))+','+str(j),ig_)
                gtype = jtu.arrset(gtype,ig,'<>')
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['O'+str(i)+','+str(j)]])
                valA = jtu.append(valA,float(1.0))
        for i in range(int(v_['1']),int(v_['N-1'])+1):
            ...
            for j in range(int(v_['1']),int(v_['5'])+1):
                ...
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['T'+str(int(v_['k+1']))+','+str(j)]])
                valA = jtu.append(valA,float(1.0))
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['T'+str(i)+','+str(j)]])
                valA = jtu.append(valA,float(-1.0))
            ...
            for j in range(int(v_['2']),int(v_['5'])+1):
                ...
                cnames = jtu.arrset(cnames,ig,'G'+str(i)+','+str(j))
                irA  = jtu.append(irA,[ig])
                icA  = jtu.append(icA,[ix_['O'+str(i)+','+str(int(v_['j-1']))]])
                valA = jtu.append(valA,float(-1.0))
        for j in range(int(v_['1']),int(v_['5'])+1):
            [ig,ig_,_] = jtu.s2mpj_ii('G'+str(int(v_['N']))+','+str(j),ig_)
            gtype = jtu.arrset(gtype,ig,'==')
            cnames = jtu.arrset(cnames,ig,'G'+str(int(v_['N']))+','+str(j))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['T'+str(int(v_['1']))+','+str(j)]])
            valA = jtu.append(valA,float(1.0))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['T'+str(int(v_['N']))+','+str(j)]])
            valA = jtu.append(valA,float(-1.0))
            [ig,ig_,_] = jtu.s2mpj_ii('G'+str(int(v_['N']))+','+str(j),ig_)
            gtype = jtu.arrset(gtype,ig,'==')
            cnames = jtu.arrset(cnames,ig,'G'+str(int(v_['N']))+','+str(j))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['O'+str(int(v_['N']))+','+str(j)]])
            valA = jtu.append(valA,float(1.0))
        for j in range(int(v_['2']),int(v_['5'])+1):
            v_['j-1'] = -1+j
            [ig,ig_,_] = jtu.s2mpj_ii('G'+str(int(v_['N']))+','+str(j),ig_)
            ...
            cnames = jtu.arrset(cnames,ig,'G'+str(int(v_['N']))+','+str(j))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['O'+str(int(v_['N']))+','+str(int(v_['j-1']))]])
            valA = jtu.append(valA,float(-1.0))
        for i in range(int(v_['1']),int(v_['N'])+1):
            [ig,ig_,_] = jtu.s2mpj_ii('A'+str(i)+','+str(int(v_['1'])),ig_)
            gtype = jtu.arrset(gtype,ig,'==')
            cnames = jtu.arrset(cnames,ig,'A'+str(i)+','+str(int(v_['1'])))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['O'+str(i)+','+str(int(v_['2']))]])
            valA = jtu.append(valA,float(-1.0))
            [ig,ig_,_] = jtu.s2mpj_ii('A'+str(i)+','+str(int(v_['2'])),ig_)
            gtype = jtu.arrset(gtype,ig,'==')
            cnames = jtu.arrset(cnames,ig,'A'+str(i)+','+str(int(v_['2'])))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['O'+str(i)+','+str(int(v_['3']))]])
            valA = jtu.append(valA,float(-1.0))
            [ig,ig_,_] = jtu.s2mpj_ii('A'+str(i)+','+str(int(v_['3'])),ig_)
            gtype = jtu.arrset(gtype,ig,'==')
            cnames = jtu.arrset(cnames,ig,'A'+str(i)+','+str(int(v_['3'])))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['O'+str(i)+','+str(int(v_['4']))]])
            valA = jtu.append(valA,float(-1.0))
            [ig,ig_,_] = jtu.s2mpj_ii('V'+str(i)+','+str(int(v_['2'])),ig_)
            gtype = jtu.arrset(gtype,ig,'==')
            cnames = jtu.arrset(cnames,ig,'V'+str(i)+','+str(int(v_['2'])))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['V'+str(i)+','+str(int(v_['2']))]])
            valA = jtu.append(valA,float(-1.0))
            v_['C'] = 961.6
            v_['C'] = 1.0/v_['C']
            [ig,ig_,_] = jtu.s2mpj_ii('V'+str(i)+','+str(int(v_['2'])),ig_)
            ...
            cnames = jtu.arrset(cnames,ig,'V'+str(i)+','+str(int(v_['2'])))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['T'+str(i)+','+str(int(v_['2']))]])
            ...
            cnames = jtu.arrset(cnames,ig,'V'+str(i)+','+str(int(v_['2'])))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['T'+str(i)+','+str(int(v_['3']))]])
            valA = jtu.append(valA,float(v_['C']))
            [ig,ig_,_] = jtu.s2mpj_ii('W'+str(i)+','+str(int(v_['2'])),ig_)
            gtype = jtu.arrset(gtype,ig,'==')
            cnames = jtu.arrset(cnames,ig,'W'+str(i)+','+str(int(v_['2'])))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['W'+str(i)+','+str(int(v_['2']))]])
            valA = jtu.append(valA,float(-1.0))
            v_['C'] = 480.8
            v_['C'] = 1.0/v_['C']
            [ig,ig_,_] = jtu.s2mpj_ii('W'+str(i)+','+str(int(v_['2'])),ig_)
            ...
            icA  = jtu.append(icA,[ix_['T'+str(i)+','+str(int(v_['3']))]])
            valA = jtu.append(valA,float(v_['C']))
            [ig,ig_,_] = jtu.s2mpj_ii('V'+str(i)+','+str(int(v_['3'])),ig_)
            gtype = jtu.arrset(gtype,ig,'==')
            cnames = jtu.arrset(cnames,ig,'V'+str(i)+','+str(int(v_['3'])))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['V'+str(i)+','+str(int(v_['3']))]])
            valA = jtu.append(valA,float(-1.0))
            v_['C'] = 4.6
            v_['C'] = 1.0/v_['C']
            [ig,ig_,_] = jtu.s2mpj_ii('V'+str(i)+','+str(int(v_['3'])),ig_)
            ...
            icA  = jtu.append(icA,[ix_['T'+str(i)+','+str(int(v_['3']))]])
            valA = jtu.append(valA,float(v_['C']))
            [ig,ig_,_] = jtu.s2mpj_ii('W'+str(i)+','+str(int(v_['3'])),ig_)
            gtype = jtu.arrset(gtype,ig,'==')
            cnames = jtu.arrset(cnames,ig,'W'+str(i)+','+str(int(v_['3'])))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['W'+str(i)+','+str(int(v_['3']))]])
            valA = jtu.append(valA,float(-1.0))
            v_['C'] = 4.6
            v_['C'] = 1.0/v_['C']
            [ig,ig_,_] = jtu.s2mpj_ii('W'+str(i)+','+str(int(v_['3'])),ig_)
            ...
            cnames = jtu.arrset(cnames,ig,'W'+str(i)+','+str(int(v_['3'])))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['T'+str(i)+','+str(int(v_['4']))]])
            valA = jtu.append(valA,float(v_['C']))
            [ig,ig_,_] = jtu.s2mpj_ii('V'+str(i)+','+str(int(v_['4'])),ig_)
            gtype = jtu.arrset(gtype,ig,'==')
            cnames = jtu.arrset(cnames,ig,'V'+str(i)+','+str(int(v_['4'])))
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['V'+str(i)+','+str(int(v_['4']))]])
            valA = jtu.append(valA,float(-1.0))
            v_['C'] = 105.15
            v_['C'] = 1.0/v_['C']
            [ig,ig_,_] = jtu.s2mpj_ii('V'+str(i)+','+str(int(v_['4'])),ig_)
        ...
        for i in range(int(v_['1']),int(v_['N'])+1):
            self.xlower = jtu.np_like_set(self.xlower, jnp.array([ix_['W'+str(i)+','+str(int(v_['2']))]]), 0.0001)
            self.xlower = jtu.np_like_set(self.xlower, jnp.array([ix_['W'+str(i)+','+str(int(v_['3']))]]), 0.0001)
            self.xlower = jtu.np_like_set(self.xlower, jnp.array([ix_['V'+str(i)+','+str(int(v_['4']))]]), 0.0001)
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        ...
        iet_  = {}
        elftv = []
        [it,iet_,_] = jtu.s2mpj_ii( 'en1VAR', iet_)
        elftv = jtu.loaset(elftv,it,0,'V')
        elftp = []
        elftp = jtu.loaset(elftp,it,0,'P')
        [it,iet_,_] = jtu.s2mpj_ii( 'en2VAR', iet_)
        elftv = jtu.loaset(elftv,it,0,'V')
        ...
        for i in range(int(v_['1']),int(v_['N'])+1):
            ...
            self.elftype = jtu.arrset(self.elftype,ie,'en2VAR')
            ielftype = jtu.arrset(ielftype,ie,iet_["en2VAR"])
            ename = 'B'+str(i)+','+str(int(v_['1']))
            [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
            ...
            self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(0.0841168))
            ...
            [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
            posep = jnp.where(elftp[ielftype[ie]]=='P')[0]
            self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(0.1280849))
            ename = 'B'+str(i)+','+str(int(v_['3']))
            [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
            self.elftype = jtu.arrset(self.elftype,ie,'en1VAR')
            ielftype = jtu.arrset(ielftype,ie,iet_["en1VAR"])
            ename = 'B'+str(i)+','+str(int(v_['3']))
            [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
            ...
            [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
            posep = jnp.where(elftp[ielftype[ie]]=='P')[0]
            self.elpar = jtu.loaset(self.elpar,ie,posep[0],float(0.2605))
        #%%%%%%%%%%%%%%%%%%%%% GRFTYPE %%%%%%%%%%%%%%%%%%%%
        igt_ = {}
    ...
    def en1VAR(self, nargout,*args):
        ...
        if nargout>1:
            try:
                ...
                dim = len(EV_)
            g_ = jnp.zeros(dim)
            g_ = jtu.np_like_set(g_, 0, self.elpar[iel_][0]*2.2*EV_[0]**1.2)
            if nargout>2:
                H_ = jnp.zeros((1,1))
                H_ = jtu.np_like_set(H_, jnp.array([0,0]), self.elpar[iel_][0]*2.64*EV_[0]**0.2)
        if nargout == 1:
            return f_
        elif nargout == 2:
            return f_,g_
    ...
    def en2VAR(self, nargout,*args):
        ...
        if nargout>1:
            try:
                ...
                dim = len(EV_)
            g_ = jnp.zeros(dim)
            g_ = jtu.np_like_set(g_, 0, self.elpar[iel_][0]*2.0*EV_[0]*EV_[1]**0.5)
            g_ = jtu.np_like_set(g_, 1, self.elpar[iel_][0]*0.5*EV_[0]**2/EV_[1]**0.5)
            if nargout>2:
                H_ = jnp.zeros((2,2))
                H_ = jtu.np_like_set(H_, jnp.array([0,0]), self.elpar[iel_][0]*2.0*EV_[1]**0.5)
                H_ = jtu.np_like_set(H_, jnp.array([0,1]), self.elpar[iel_][0]*EV_[0]/EV_[1]**0.5)
                H_ = jtu.np_like_set(H_, jnp.array([1,0]), H_[0,1])
                H_ = jtu.np_like_set(H_, jnp.array([1,1]), -self.elpar[iel_][0]*0.25*EV_[0]**2/EV_[1]**1.5)
        if nargout == 1:
            return f_
        elif nargout == 2:
            return f_,g_
