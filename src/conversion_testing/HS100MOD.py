...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        valA = jtu.append(valA,float(1.0))
        self.gscale = jtu.arrset(self.gscale,ig,float(0.2))
        [ig,ig_,_] = jtu.s2mpj_ii('O4',ig_)
        gtype = jtu.arrset(gtype,ig,'<>')
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['X4']])
        valA = jtu.append(valA,float(1.0))
        self.gscale = jtu.arrset(self.gscale,ig,float(0.3333333333))
        ...
        irA  = jtu.append(irA,[ig])
        icA  = jtu.append(icA,[ix_['X6']])
        valA = jtu.append(valA,float(2193.0))
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        self.n   = len(ix_)
        ngrp   = len(ig_)
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['O1'],float(10.0))
        self.gconst = jtu.arrset(self.gconst,ig_['O2'],float(12.0))
        self.gconst = jtu.arrset(self.gconst,ig_['O4'],float(11.0))
        ...
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['X5P6'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,float(10.0))
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['EL'])
        self.grelw = jtu.loaset(self.grelw,ig,posel, 1.)
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['X3P4'])
        nlc = jnp.union1d(nlc,jnp.array([ig]))
        self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
        ig = ig_['C1']
        posel = len(self.grelt[ig])
        ...
        posel = posel+1
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['X2P4'])
