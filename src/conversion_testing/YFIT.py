...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.xlower = jtu.np_like_set(self.xlower, ix_['alpha'], -float('Inf'))
        self.xupper = jtu.np_like_set(self.xupper, ix_['alpha'], +float('Inf'))
        self.xlower = jtu.np_like_set(self.xlower, ix_['beta'], -float('Inf'))
        self.xupper = jtu.np_like_set(self.xupper, ix_['beta'], +float('Inf'))
        self.xlower = jtu.np_like_set(self.xlower, ix_['dist'], 0.0)
        #%%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
