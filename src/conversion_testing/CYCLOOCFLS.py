...
# IE P                   100000         $-PARAMETER
        ...
        [iv,ix_,_] = jtu.s2mpj_ii('Y2',ix_)
        self.xnames=jtu.arrset(self.xnames,iv,'Y2')
        ...
        for I in range(int(v_['1']),int(v_['P'])+1):
            self.gconst = jtu.arrset(self.gconst,ig_['A'+str(I)],float(v_['C2']))
            self.gconst = jtu.arrset(self.gconst,ig_['B'+str(I)],float(v_['SC2']))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        self.x0 = jtu.np_like_set(self.x0, ix_['Y2'], float(v_['START']))
        self.x0 = jtu.np_like_set(self.x0, ix_['Z3'], float(v_['START']))
        for I in range(int(v_['3']),int(v_['P'])+1):
            v_['RI'] = float(I)
            v_['START'] = v_['RI']/v_['RP']
            self.x0 = jtu.np_like_set(self.x0, ix_['X'+str(I)], float(v_['START']))
            self.x0 = jtu.np_like_set(self.x0, ix_['Y'+str(I)], float(v_['START']))
            self.x0 = jtu.np_like_set(self.x0, ix_['Z'+str(I)], float(v_['START']))
        v_['RI'] = 2.0
        v_['START'] = v_['RI']/v_['RP']
        pass
        for I in range(int(v_['3']),int(v_['P'])+1):
        ...
        [it,iet_,_] = jtu.s2mpj_ii( 'eSQRDIF', iet_)
        ...
        ename = 'AY'+str(int(v_['I']))
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        self.elftype = jtu.arrset(self.elftype,ie,'eSQRDIF')
        ielftype = jtu.arrset(ielftype,ie,iet_["eSQRDIF"])
        ename = 'AY'+str(int(v_['I']))
        [ie,ie_,_] = jtu.s2mpj_ii(ename,ie_)
        ...
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['AY'+str(int(v_['I']))])
        self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['AZ'+str(int(v_['I']))])
        self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
        ig = ig_['B'+str(int(v_['I']))]
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['BX'+str(int(v_['I']))])
        self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['BY'+str(int(v_['I']))])
        self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
        posel = len(self.grelt[ig])
        self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['BZ'+str(int(v_['I']))])
        self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
        for I in range(int(v_['2']),int(v_['P'])+1):
            ig = ig_['A'+str(I)]
            posel = len(self.grelt[ig])
            self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['AX'+str(I)])
            self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
            posel = len(self.grelt[ig])
            self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['AY'+str(I)])
            self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
            posel = len(self.grelt[ig])
            self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['AZ'+str(I)])
            self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
            ig = ig_['B'+str(I)]
            posel = len(self.grelt[ig])
            self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['BX'+str(I)])
            self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
            posel = len(self.grelt[ig])
            self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['BY'+str(I)])
            self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
            posel = len(self.grelt[ig])
            self.grelt = jtu.loaset(self.grelt,ig,posel,ie_['BZ'+str(I)])
            self.grelw = jtu.loaset(self.grelw,ig,posel,1.)
        #%%%%%%%%%%%%%%%%%% OBJECT BOUNDS %%%%%%%%%%%%%%%%%
# LO SOLUTION             0.0
