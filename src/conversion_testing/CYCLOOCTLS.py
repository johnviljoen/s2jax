...
# IE P                   100000         $-PARAMETER
        ...
        self.xupper = jtu.np_like_set(self.xupper, ix_['X1'], 0.0)
        self.xlower = jtu.np_like_set(self.xlower, ix_['Y1'], 0.0)
        self.xupper = jtu.np_like_set(self.xupper, ix_['Y1'], 0.0)
        self.xlower = jtu.np_like_set(self.xlower, ix_['Z1'], 0.0)
        self.xupper = jtu.np_like_set(self.xupper, ix_['Z1'], 0.0)
        self.xlower = jtu.np_like_set(self.xlower, ix_['X2'], 0.0)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X2'], 0.0)
        #%%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
