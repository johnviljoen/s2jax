...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        for I in range(int(v_['0']),int(v_['M'])+1):
            ...
            valA = jtu.append(valA,float(v_['-W**2']))
        ...
        for I in range(int(v_['0']),int(v_['M'])+1):
            ...
            v_['W'] = v_['RI']*v_['H']
            v_['W'] = v_['W']+v_['LOWER']
            v_['SINW'] = jnp.sin(v_['W'])
            v_['-SINW'] = -1.0*v_['SINW']
            self.gconst = jtu.arrset(self.gconst,ig_['LO'+str(I)],float(v_['-SINW']))
            self.gconst = jtu.arrset(self.gconst,ig_['UP'+str(I)],float(v_['SINW']))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
