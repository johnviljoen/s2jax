...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['OBJ'],float(100.0))
        self.gconst = jtu.arrset(self.gconst,ig_['CON1'],float(10.0))
        #%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        self.xlower = jnp.zeros((self.n,1))
        self.xupper = jnp.full((self.n,1),float('inf'))
        self.xlower = jtu.np_like_set(self.xlower, ix_['X1'], 2.0)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X1'], 50.0)
        self.xlower = jtu.np_like_set(self.xlower, ix_['X2'], -50.0)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X2'], 50.0)
        self.xlower = jtu.np_like_set(self.xlower, ix_['X3'], -1.0e+30)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X3'], 50.0)
        self.xlower = jtu.np_like_set(self.xlower, ix_['X4'], 2.0)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X4'], 1.0e+30)
        self.xlower = jtu.np_like_set(self.xlower, ix_['X5'], -1.0e+30)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X5'], 1.0e+30)
        self.xlower = jtu.np_like_set(self.xlower, ix_['X6'], -1.0e+30)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X6'], 0.0e+0)
        self.xlower = jtu.np_like_set(self.xlower, ix_['X7'], 0.0e+0)
        self.xupper = jtu.np_like_set(self.xupper, ix_['X7'], 1.0e+30)
        #%%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
