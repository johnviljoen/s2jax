...
#        return pbm
    ...
    def extfunc(self,X):
        ...
        Y = jtu.np_like_set(Y, jnp.array([6,2]), ( C[6,1]/C[0,2] - 2.0*C[1,1]*C[1,2]/C[0,2]**2                     - C[0,1]*C[6,2]/C[0,2]**2 + 2.0*C[0,1]*C[1,2]**2/C[0,2]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([12,2]), ( C[12,1]/C[0,2] -  C[1,1]*C[4,2]/C[0,2]**2 - C[4,1]*C[1,2]/C[0,2]**2                   - C[0,1]*C[12,2]/C[0,2]**2 + 2.0*C[0,1]*C[1,2]*C[4,2]/C[0,2]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([15,2]), ( C[15,1]/C[0,2] - 2.0*C[4,1]*C[4,2]/C[0,2]**2                    - C[0,1]*C[15,2]/C[0,2]**2 + 2.0*C[0,1]*C[4,2]**2/C[0,2]**3 ))
        ...
        C = jtu.np_like_set(C, jnp.array([6,3]), ( A*( - Y[6,2]) + 2.0*B*( 1.0 - Y[1,2])**2/X2 + 2.0*B*( X1 - Y[0,2])*( - Y[6,2])/X2                   + D*Y[6,3] + E*Y[6,2] ))
        C = jtu.np_like_set(C, jnp.array([7,3]), - 2.0*B*( X1 - Y[0,2])*( 1.0 - Y[1,2])/X2**2)
        C = jtu.np_like_set(C, jnp.array([8,3]), 2.0*B*( ( X1 - Y[0,2])**2)/X2**3)
        C = jtu.np_like_set(C, jnp.array([12,3]), ( A*( - Y[12,2]) + 2.0*B*( - Y[4,2])*( 1.0 - Y[1,2])/X2                   + 2.0*B*( X1 - Y[0,2])*( - Y[12,2])/X2 + D*Y[12,3] + E*Y[12,2] ))
        C = jtu.np_like_set(C, jnp.array([13,3]), - 2.0*B*( X1 - Y[0,2])*( - Y[4,2])/X2**2)
        C = jtu.np_like_set(C, jnp.array([15,3]), ( A*( - Y[15,2]) + 2.0*B*( - Y[4,2])**2/X2 + 2.0*B*( X1 - Y[0,2])*( - Y[15,2])/X2                   + D*Y[15,3] + E*Y[15,2] ))
        # Function C5.
        ...
        C = jtu.np_like_set(C, jnp.array([8,6]), ( - C[8,3]/C[0,4] + 2.0*C[2,3]*C[2,4]/C[0,4]**2 + C[0,3]*C[8,4]/C[0,4]**2                   - 2.0*C[0,3]*C[2,4]**2/C[0,4]**3 ))
        ...
        Y = jtu.np_like_set(Y, jnp.array([10,6]), ( C[10,7]/Y[0,0] -  C[2,7]*Y[3,0]/Y[0,0]**2 - C[3,7]*Y[2,0]/Y[0,0]**2                   + 2.0*C[0,7]*Y[2,0]*Y[3,0]/Y[0,0]**3 ))
        ...
        C = jtu.np_like_set(C, jnp.array([6,8]), ( Y[6,6] - A*Y[6,6]/Y[0,7] + 2.0*A*Y[1,6]*Y[1,7]/Y[0,7]**2                   + A*Y[0,6]*Y[6,7]/Y[0,7]**2 - 2.0*A*Y[0,6]*Y[1,7]**2/Y[0,7]**3 ))
        C = jtu.np_like_set(C, jnp.array([7,8]), ( Y[7,6] - A*Y[7,6]/Y[0,7] + A*Y[1,6]*Y[2,7]/ Y[0,7]**2                   + A*Y[2,6]*Y[1,7]/Y[0,7]**2 + A*Y[0,6]*Y[7,7]/Y[0,7]**2                   - 2.0*A*Y[0,6]*Y[1,7]*Y[2,7]/Y[0,7]**3 ))
        C = jtu.np_like_set(C, jnp.array([8,8]), ( Y[8,6] - A*Y[8,6]/Y[0,7] +  2.0*A*Y[2,6]*Y[2,7]/Y[0,7]**2                   + A*Y[0,6]*Y[8,7]/Y[0,7]**2 - 2.0*A*Y[0,6]*Y[2,7]**2/Y[0,7]**3 ))
        C = jtu.np_like_set(C, jnp.array([9,8]), ( Y[9,6] - A*Y[9,6]/Y[0,7]                   + A*Y[1,6]*Y[3,7]/ Y[0,7]**2 +  A*Y[3,6]*Y[1,7]/Y[0,7]**2                   + A*Y[0,6]*Y[9,7]/Y[0,7]**2 - 2.0*A*Y[0,6]*Y[1,7]*Y[3,7]/Y[0,7]**3 ))
        C = jtu.np_like_set(C, jnp.array([10,8]), ( Y[10,6] - A*Y[10,6]/Y[0,7]                   + A*Y[2,6]*Y[3,7]/ Y[0,7]**2 + A*Y[3,6]*Y[2,7]/Y[0,7]**2                   + A*Y[0,6]*Y[10,7]/Y[0,7]**2 -2.0*A*Y[0,6]*Y[2,7]*Y[3,7]/Y[0,7]**3 ))
        C = jtu.np_like_set(C, jnp.array([11,8]), ( Y[11,6] - A*Y[11,6]/Y[0,7] + 2.0*A*Y[3,6]*Y[3,7]/Y[0,7]**2                   + A*Y[0,6]*Y[11,7]/Y[0,7]**2 - 2.0*A*Y[0,6]*Y[3,7]**2/Y[0,7]**3 ))
        C = jtu.np_like_set(C, jnp.array([12,8]), ( Y[12,6] - A*Y[12,6]/Y[0,7]                   + A*Y[1,6]*Y[4,7]/ Y[0,7]**2 + A*Y[4,6]*Y[1,7]/Y[0,7]**2                   + A*Y[0,6]*Y[12,7]/Y[0,7]**2 - 2.0*A*Y[0,6]*Y[1,7]*Y[4,7]/Y[0,7]**3 ))
        C = jtu.np_like_set(C, jnp.array([13,8]), ( Y[13,6] - A*Y[13,6]/Y[0,7]                   + A*Y[2,6]*Y[4,7]/ Y[0,7]**2 + A*Y[4,6]*Y[2,7]/Y[0,7]**2                   + A*Y[0,6]*Y[13,7]/Y[0,7]**2 - 2.0*A*Y[0,6]*Y[2,7]*Y[4,7]/Y[0,7]**3 ))
        C = jtu.np_like_set(C, jnp.array([14,8]), ( Y[14,6] - A*Y[14,6]/Y[0,7]                   + A*Y[3,6]*Y[4,7]/ Y[0,7]**2 + A*Y[4,6]*Y[3,7]/Y[0,7]**2                   + A*Y[0,6]*Y[14,7]/Y[0,7]**2 - 2.0*A*Y[0,6]*Y[3,7]*Y[4,7]/Y[0,7]**3 ))
        C = jtu.np_like_set(C, jnp.array([15,8]), ( Y[15,6] - A*Y[15,6]/Y[0,7] + 2.0*A*Y[4,6]*Y[4,7]/Y[0,7]**2                   + A*Y[0,6]*Y[15,7]/Y[0,7]**2 - 2.0*A*Y[0,6]*Y[4,7]**2/Y[0,7]**3 ))
        ...
        Y = jtu.np_like_set(Y, jnp.array([6,11]), ( C[6,10]/C[0,11] - 2.0*C[1,10]*C[1,11]/C[0,11]**2                    - C[0,10]*C[6,11]/C[0,11]**2 + 2.0*C[0,10]*C[1,11]**2/C[0,11]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([7,11]), ( C[1,10]*C[2,11]/C[0,11]**2 -C[0,10]*C[7,11]/C[0,11]**2                    + 2.0*C[0,10]*C[1,11]*C[2,11]/C[0,11]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([8,11]), - C[0,10]*C[8,11]/C[0,11]**2 + 2.0*C[0,10]*C[2,11]**2/C[0,11]**3)
        Y = jtu.np_like_set(Y, jnp.array([12,11]), ( C[12,10]/C[0,11] - C[1,10]*C[4,11]/C[0,11]**2                    - C[4,10]*C[1,11]/C[0,11]**2 - C[0,10]*C[12,11]/C[0,11]**2                    + 2.0*C[0,10]*C[1,11]*C[4,11]/C[0,11]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([13,11]), (- C[4,10]*C[2,11]/C[0,11]**2 -  C[0,10]*C[13,11]/C[0,11]**2                    + 2.0*C[0,10]*C[2,11]*C[4,11]/C[0,11]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([15,11]), ( C[15,10]/C[0,11] - 2.0*C[4,10]*C[4,11]/C[0,11]**2                    - C[0,10]*C[15,11]/C[0,11]**2 + 2.0*C[0,10]*C[4,11]**2/C[0,11]**3 ))
        ...
        Y = jtu.np_like_set(Y, jnp.array([6,14]), ( Y[6,12]/C[0,12] - 2.0*Y[1,12]*C[1,12]/C[0,12]**2                     - Y[0,12]*C[6,12]/C[0,12]**2 + 2.0*Y[0,12]*C[1,12]**2/C[0,12]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([7,14]), ( Y[7,12]/C[0,12] - Y[1,12]*C[2,12]/C[0,12]**2 - Y[2,12]*C[1,12]/C[0,12]**2                    - Y[0,12]*C[7,12]/C[0,12]**2 + 2.0*Y[0,12]*C[1,12]*C[2,12]/C[0,12]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([8,14]), ( Y[8,12]/C[0,12] - 2.0*Y[2,12]*C[2,12]/C[0,12]**2                    - Y[0,12]*C[8,12]/C[0,12]**2 + 2.0*Y[0,12]*C[2,12]**2/C[0,12]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([9,14]), ( Y[9,12]/C[0,12] - Y[1,12]*C[3,12]/C[0,12]**2 - Y[3,12]*C[1,12]/C[0,12]**2                    - Y[0,12]*C[9,12]/C[0,12]**2 + 2.0*Y[0,12]*C[1,12]*C[3,12]/C[0,12]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([10,14]), ( Y[2,12]*C[3,12]/C[0,12]**2 - Y[0,12]*C[10,12]/C[0,12]**2                     + 2.0*Y[0,12]*C[2,12]*C[3,12]/C[0,12]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([11,14]), - Y[0,12]*C[11,12]/C[0,12]**2 + 2.0*Y[0,12]*C[3,12]**2/C[0,12]**3)
        Y = jtu.np_like_set(Y, jnp.array([12,14]), ( Y[12,12]/C[0,12] - Y[1,12]*C[4,12]/C[0,12]**2 - Y[4,12]*C[1,12]/C[0,12]**2                    - Y[0,12]*C[12,12]/C[0,12]**2 + 2.0*Y[0,12]*C[1,12]*C[4,12]/C[0,12]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([13,14]), ( Y[13,12]/C[0,12] - Y[2,12]*C[4,12]/C[0,12]**2 - Y[4,12]*C[2,12]/C[0,12]**2                    - Y[0,12]*C[13,12]/C[0,12]**2 + 2.0*Y[0,12]*C[2,12]*C[4,12]/C[0,12]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([14,14]), ( - Y[4,12]*C[3,12]/C[0,12]**2 - Y[0,12]*C[14,12]/C[0,12]**2                    + 2.0*Y[0,12]*C[3,12]*C[4,12]/C[0,12]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([15,14]), ( Y[15,12]/C[0,12] - 2.0*Y[4,12]*C[4,12]/C[0,12]**2                     - Y[0,12]*C[15,12]/C[0,12]**2 + 2.0*Y[0,12]*C[4,12]**2/C[0,12]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([16,14]), ( - Y[1,12]*C[5,12]/C[0,12]**2 -Y[0,12]*C[16,12]/C[0,12]**2                    + 2.0*Y[0,12]*C[1,12]*C[5,12]/C[0,12]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([17,14]), (- Y[2,12]*C[5,12]/C[0,12]**2 - Y[0,12]*C[17,12]/C[0,12]**2                    + 2.0*Y[0,12]*C[2,12]*C[5,12]/C[0,12]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([18,14]), - Y[0,12]*C[18,12]/C[0,12]**2 + 2.0*Y[0,12]*C[3,12]*C[5,12]/C[0,12]**3)
        Y = jtu.np_like_set(Y, jnp.array([19,14]), ( - Y[4,12]*C[5,12]/C[0,12]**2 - Y[0,12]*C[19,12]/C[0,12]**2                    + 2.0*Y[0,12]*C[4,12]*C[5,12]/C[0,12]**3 ))
        ...
        Y = jtu.np_like_set(Y, jnp.array([6,15]), ( B*Y[6,14] + D*Y[6,12]                    + E*( Y[6,14]*Y[0,12] + Y[0,14]*Y[6,12]  + 2.0*Y[1,14]*Y[1,12] ) ))
        Y = jtu.np_like_set(Y, jnp.array([7,15]), ( B*Y[7,14] + D*Y[7,12]                    + E*( Y[7,14]*Y[0,12] + Y[0,14]*Y[7,12] + Y[1,14]*Y[2,12] + Y[2,14]*Y[1,12] ) ))
        Y = jtu.np_like_set(Y, jnp.array([8,15]), ( B*Y[8,14] + D*Y[8,12]                     + E*( Y[8,14]*Y[0,12] + Y[0,14]*Y[8,12] + 2.0*Y[2,14]*Y[2,12] ) ))
        ...
        Y = jtu.np_like_set(Y, jnp.array([12,15]), ( B*Y[12,14] + D*Y[12,12]                    + E*( Y[12,14]*Y[0,12] + Y[0,14]*Y[12,12] + Y[1,14]*Y[4,12] + Y[4,14]*Y[1,12] ) ))
        Y = jtu.np_like_set(Y, jnp.array([13,15]), ( B*Y[13,14] + D*Y[13,12]                     + E*( Y[13,14]*Y[0,12] + Y[0,14]*Y[13,12] + Y[2,14]*Y[4,12] + Y[4,14]*Y[2,12] ) ))
        Y = jtu.np_like_set(Y, jnp.array([14,15]), B*Y[14,14] + E*( Y[14,14]*Y[0,12] + Y[3,14]*Y[4,12]))
        Y = jtu.np_like_set(Y, jnp.array([15,15]), ( B*Y[15,14] + D*Y[15,12]                    + E*( Y[15,14]*Y[0,12] + Y[0,14]*Y[15,12] + 2.0*Y[4,14]*Y[4,12] ) ))
        ...
        Y = jtu.np_like_set(Y, jnp.array([6,16]), ( B*Y[6,9] + D*Y[6,10] + C[6,13]/C[0,11] - C[0,13]*C[6,11]/C[0,11]**2                    - 2.0*C[1,13]*C[1,11]/C[0,11]**2 + 2.0*C[0,13]*C[1,11]**2/C[0,11]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([7,16]), ( B*Y[7,9] + C[7,13]/C[0,11] - C[1,13]*C[2,11]/C[0,11]**2                    - C[2,13]*C[1,11]/C[0,11]**2 - C[0,13]*C[7,11]/C[0,11]**2                    + 2.0*C[0,13]*C[1,11]*C[2,11]/C[0,11]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([8,16]), ( B*Y[8,9] + C[8,13]/C[0,11] - C[0,13]*C[8,11]/C[0,11]**2                    - 2.0*C[2,13]*C[2,11]/C[0,11]**2 + 2.0*C[0,13]*C[2,11]**2/C[0,11]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([12,16]), ( B*Y[12,9] + D*Y[12,10] + C[12,13]/C[0,11] - C[1,13]*C[4,11]/C[0,11]**2                    - C[4,13]*C[1,11]/C[0,11]**2 - C[0,13]*C[12,11]/C[0,11]**2                    + 2.0*C[0,13]*C[1,11]*C[4,11]/C[0,11]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([13,16]), ( B*Y[13,9] + C[13,13]/C[0,11] - C[2,13]*C[4,11]/C[0,11]**2                    - C[4,13]*C[2,11]/C[0,11]**2                    - C[0,13]*C[13,11]/C[0,11]**2 + 2.0*C[0,13]*C[2,11]*C[4,11]/C[0,11]**3 ))
        Y = jtu.np_like_set(Y, jnp.array([15,16]), ( B*Y[15,9] + D*Y[15,10] + C[15,13]/C[0,11] - C[0,13]*C[15,11]/C[0,11]**2                    - 2.0*C[4,13]*C[4,11]/C[0,11]**2 + 2.0*C[0,13]*C[4,11]**2/C[0,11]**3 ))
        ...
        C = jtu.np_like_set(C, jnp.array([6,14]), ( Y[6,12]/Y[0,14] - 2.0*Y[1,12]*Y[1,14]/Y[0,14]**2 - Y[0,12]*Y[6,14]/Y[0,14]**2                    + 2.0*Y[0,12]*Y[1,14]**2/Y[0,14]**3 - Y[6,12]/A ))
        C = jtu.np_like_set(C, jnp.array([7,14]), ( Y[7,12]/Y[0,14] - Y[1,12]*Y[2,14]/Y[0,14]**2 - Y[2,12]*Y[1,14]/Y[0,14]**2                    - Y[0,12]*Y[7,14]/Y[0,14]**2 + 2.0*Y[0,12]*Y[1,14]*Y[2,14]/Y[0,14]**3                    - Y[7,12]/A ))
        C = jtu.np_like_set(C, jnp.array([8,14]), ( Y[8,12]/Y[0,14] - 2.0*Y[2,12]*Y[2,14]/Y[0,14]**2 - Y[0,12]*Y[8,14]/Y[0,14]**2                    + 2.0*Y[0,12]*Y[2,14]**2/Y[0,14]**3 - Y[8,12]/A ))
        C = jtu.np_like_set(C, jnp.array([9,14]), ( Y[9,12]/Y[0,14] - Y[1,12]*Y[3,14]/Y[0,14]**2 - Y[3,12]*Y[1,14]/Y[0,14]**2                    - Y[0,12]*Y[9,14]/Y[0,14]**2 + 2.0*Y[0,12]*Y[1,14]*Y[3,14]/Y[0,14]**3 ))
        C = jtu.np_like_set(C, jnp.array([10,14]), ( Y[2,12]*Y[3,14]/Y[0,14]**2 - Y[0,12]*Y[10,14]/Y[0,14]**2                    + 2.0*Y[0,12]*Y[2,14]*Y[3,14]/Y[0,14]**3 ))
        C = jtu.np_like_set(C, jnp.array([11,14]), - Y[0,12]*Y[11,14]/Y[0,14]**2 + 2.0*Y[0,12]*Y[3,14]**2/Y[0,14]**3)
        C = jtu.np_like_set(C, jnp.array([12,14]), ( Y[12,12]/Y[0,14] - Y[1,12]*Y[4,14]/Y[0,14]**2 - Y[4,12]*Y[1,14]/Y[0,14]**2                    - Y[0,12]*Y[12,14]/Y[0,14]**2 + 2.0*Y[0,12]*Y[1,14]*Y[4,14]/Y[0,14]**3                    - Y[12,12]/A ))
        C = jtu.np_like_set(C, jnp.array([13,14]), ( Y[13,12]/Y[0,14] - Y[2,12]*Y[4,14]/Y[0,14]**2 - Y[4,12]*Y[2,14]/Y[0,14]**2                    - Y[0,12]*Y[13,14]/Y[0,14]**2 + 2.0*Y[0,12]*Y[2,14]*Y[4,14]/Y[0,14]**3                    - Y[13,12]/A ))
        C = jtu.np_like_set(C, jnp.array([14,14]), ( - Y[4,12]*Y[3,14]/Y[0,14]**2 - Y[0,12]*Y[14,14]/Y[0,14]**2                     + 2.0*Y[0,12]*Y[3,14]*Y[4,14]/Y[0,14]**3 ))
        C = jtu.np_like_set(C, jnp.array([15,14]), ( Y[15,12]/Y[0,14] - 2.0*Y[4,12]*Y[4,14]/Y[0,14]**2                    - Y[0,12]*Y[15,14]/Y[0,14]**2 + 2.0*Y[0,12]*Y[4,14]**2/Y[0,14]**3                    - Y[15,12]/A ))
        C = jtu.np_like_set(C, jnp.array([16,14]), ( - Y[1,12]*Y[5,14]/Y[0,14]**2 - Y[0,12]*Y[16,14]/Y[0,14]**2                    + 2.0*Y[0,12]*Y[1,14]*Y[5,14]/Y[0,14]**3 ))
        C = jtu.np_like_set(C, jnp.array([17,14]), ( - Y[2,12]*Y[5,14]/Y[0,14]**2 - Y[0,12]*Y[17,14]/Y[0,14]**2                     + 2.0*Y[0,12]*Y[2,14]*Y[5,14]/Y[0,14]**3 ))
        C = jtu.np_like_set(C, jnp.array([18,14]), - Y[0,12]*Y[18,14]/Y[0,14]**2 + 2.0*Y[0,12]*Y[3,14]*Y[5,14]/Y[0,14]**3)
        C = jtu.np_like_set(C, jnp.array([19,14]), ( - Y[4,12]*Y[5,14]/Y[0,14]**2 - Y[0,12]*Y[19,14]/Y[0,14]**2                    + 2.0*Y[0,12]*Y[4,14]*Y[5,14]/Y[0,14]**3 ))
        ...
        C = jtu.np_like_set(C, jnp.array([6,17]), ( C[6,14]/C[0,15] - 2.0*C[1,14]*C[1,15]/C[0,15]**2                    - C[0,14]*C[6,15]/C[0,15]**2 + 2.0*C[0,14]*C[1,15]**2/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([7,17]), ( C[7,14]/C[0,15] - C[1,14]*C[2,15]/C[0,15]**2 - C[2,14]*C[1,15]/C[0,15]**2                    - C[0,14]*C[7,15]/C[0,15]**2 + 2.0*C[0,14]*C[1,15]*C[2,15]/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([8,17]), ( C[8,14]/C[0,15] - 2.0*C[2,14]*C[2,15]/C[0,15]**2                    - C[0,14]*C[8,15]/C[0,15]**2 + 2.0*C[0,14]*C[2,15]**2/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([9,17]), ( C[9,14]/C[0,15] - C[1,14]*C[3,15]/C[0,15]**2 - C[3,14]*C[1,15]/C[0,15]**2                    - C[0,14]*C[9,15]/C[0,15]**2 +  2.0*C[0,14]*C[1,15]*C[3,15]/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([10,17]), ( C[10,14]/C[0,15] - C[2,14]*C[3,15]/C[0,15]**2 - C[3,14]*C[2,15]/C[0,15]**2                    - C[0,14]*C[10,15]/C[0,15]**2 + 2.0*C[0,14]*C[2,15]*C[3,15]/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([11,17]), ( C[11,14]/C[0,15] - 2.0*C[3,14]*C[3,15]/C[0,15]**2                    - C[0,14]*C[11,15]/C[0,15]**2 + 2.0*C[0,14]*C[3,15]**2/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([12,17]), ( C[12,14]/C[0,15] - C[1,14]*C[4,15]/C[0,15]**2 - C[4,14]*C[1,15]/C[0,15]**2                    - C[0,14]*C[12,15]/C[0,15]**2 + 2.0*C[0,14]*C[1,15]*C[4,15]/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([13,17]), ( C[13,14]/C[0,15] - C[2,14]*C[4,15]/C[0,15]**2 - C[4,14]*C[2,15]/C[0,15]**2                    - C[0,14]*C[13,15]/C[0,15]**2 + 2.0*C[0,14]*C[2,15]*C[4,15]/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([14,17]), ( C[14,14]/C[0,15] - C[3,14]*C[4,15]/C[0,15]**2 - C[4,14]*C[3,15]/C[0,15]**2                    - C[0,14]*C[14,15]/C[0,15]**2 + 2.0*C[0,14]*C[3,15]*C[4,15]/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([15,17]), ( C[15,14]/C[0,15] - 2.0*C[4,14]*C[4,15]/C[0,15]**2                    - C[0,14]*C[15,15]/C[0,15]**2 + 2.0*C[0,14]*C[4,15]**2/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([16,17]), ( C[16,14]/C[0,15] - C[1,14]*C[5,15]/C[0,15]**2 - C[5,14]*C[1,15]/C[0,15]**2                    - C[0,14]*C[16,15]/C[0,15]**2 + 2.0*C[0,14]*C[1,15]*C[5,15]/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([17,17]), ( C[17,14]/C[0,15] - C[2,14]*C[5,15]/C[0,15]**2 - C[5,14]*C[2,15]/C[0,15]**2                    - C[0,14]*C[17,15]/C[0,15]**2 + 2.0*C[0,14]*C[2,15]*C[5,15]/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([18,17]), ( C[18,14]/C[0,15] - C[3,14]*C[5,15]/C[0,15]**2 - C[5,14]*C[3,15]/C[0,15]**2                    - C[0,14]*C[18,15]/C[0,15]**2 + 2.0*C[0,14]*C[3,15]*C[5,15]/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([19,17]), ( C[19,14]/C[0,15] - C[4,14]*C[5,15]/C[0,15]**2 - C[5,14]*C[4,15]/C[0,15]**2                    - C[0,14]*C[19,15]/C[0,15]**2 + 2.0*C[0,14]*C[4,15]*C[5,15]/C[0,15]**3 ))
        C = jtu.np_like_set(C, jnp.array([20,17]), ( C[20,14]/C[0,15] - 2.0*C[5,14]*C[5,15]/C[0,15]**2                    - C[0,14]*C[20,15]/C[0,15]**2 + 2.0*C[0,14]*C[5,15]**2/C[0,15]**3 ))
        ...
        C = jtu.np_like_set(C, jnp.array([12,18]), ( Y[0,1]*( 2.0*C[1,11]*C[4,11]/C[0,11]**3 - C[12,11]/C[0,11]**2 )                     - Y[4,1]*C[1,11]/C[0,11]**2 ))
        C = jtu.np_like_set(C, jnp.array([13,18]), ( Y[0,1]*( 2.0*C[2,11]*C[4,11]/C[0,11]**3 - C[13,11]/C[0,11]**2 )                     - Y[4,1]*C[2,11]/C[0,11]**2 ))
        C = jtu.np_like_set(C, jnp.array([15,18]), ( Y[15,1]/C[0,11] - 2.0*Y[4,1]*C[4,11]/C[0,11]**2                    - Y[0,1]*C[15,11]/ C[0,11]**2 + 2.0*Y[0,1]*C[4,11]**2/ C[0,11]**3 ))
