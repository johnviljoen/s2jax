...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        [ig,ig_,_] = jtu.s2mpj_ii('STRESS',ig_)
        gtype = jtu.arrset(gtype,ig,'<=')
        cnames = jtu.arrset(cnames,ig,'STRESS')
        irA  = jtu.append(irA,[ig])
        ...
        self.gconst = jtu.arrset(self.gconst,ig_['STRESS'],float(22.86))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        for I in range(int(v_['2']),int(v_['8'])+1,int(v_['2'])):
            self.xlower = jtu.np_like_set(self.xlower, ix_['U'+str(I)], -50.8)
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
