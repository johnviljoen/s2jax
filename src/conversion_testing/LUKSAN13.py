...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        for J in range(int(v_['1']),int(v_['S'])+1):
            ...
            v_['K+5'] = 5+v_['K']
            v_['K+6'] = 6+v_['K']
            self.gconst = jtu.arrset(self.gconst,ig_['E'+str(int(v_['K+4']))],float(30.0))
            self.gconst = jtu.arrset(self.gconst,ig_['E'+str(int(v_['K+5']))],float(10.0))
            self.gconst = jtu.arrset(self.gconst,ig_['E'+str(int(v_['K+6']))],float(10.0))
            v_['K'] = 7+v_['K']
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
