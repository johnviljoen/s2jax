...
# IE N                   10000          $-PARAMETER
        ...
        for I in range(int(v_['1']),int(v_['N'])+1,int(v_['4'])):
            ...
            [ig,ig_,_] = jtu.s2mpj_ii('G'+str(int(v_['I+1'])),ig_)
            gtype = jtu.arrset(gtype,ig,'<>')
            irA  = jtu.append(irA,[ig])
            ...
            [ig,ig_,_] = jtu.s2mpj_ii('G'+str(int(v_['I+2'])),ig_)
            gtype = jtu.arrset(gtype,ig,'<>')
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['X'+str(int(v_['I+1']))]])
            valA = jtu.append(valA,float(1.0))
            ...
            [ig,ig_,_] = jtu.s2mpj_ii('G'+str(int(v_['I+3'])),ig_)
            gtype = jtu.arrset(gtype,ig,'<>')
            irA  = jtu.append(irA,[ig])
            icA  = jtu.append(icA,[ix_['X'+str(I)]])
            valA = jtu.append(valA,float(1.0))
        ...
        for I in range(int(v_['1']),int(v_['N'])+1,int(v_['4'])):
            ...
            self.x0 = jtu.np_like_set(self.x0, ix_['X'+str(int(v_['I+2']))], float(0.0))
            self.x0 = jtu.np_like_set(self.x0, ix_['X'+str(int(v_['I+3']))], float(1.0))
        #%%%%%%%%%%%%%%%%%%%%% GRFTYPE %%%%%%%%%%%%%%%%%%%%
        igt_ = {}
