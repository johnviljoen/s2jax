...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.x0 = jtu.np_like_set(self.x0, ix_['X1'], float(-12.0))
        ...
        #%%%%%%%%%%%%%%%%%%%%% GRFTYPE %%%%%%%%%%%%%%%%%%%%
        igt_ = {}
        [it,igt_,_] = jtu.s2mpj_ii('gBIWEIGHT',igt_)
        #%%%%%%%%%%%%%%%%%%% GROUP USES %%%%%%%%%%%%%%%%%%%
        self.grelt   = []
        ...
        for ig in range(0,ngrp):
            self.grftype = jtu.arrset(self.grftype,ig,'gBIWEIGHT')
        ig = ig_['G1']
...
# **********************
    ...
    @staticmethod
    def gBIWEIGHT(self,nargout,*args):
