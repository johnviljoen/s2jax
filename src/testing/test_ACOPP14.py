...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        self.cupper[jnp.arange(self.nle)] = jnp.zeros((self.nle,1))
        self.clower[jnp.arange(self.nle,self.nle+self.neq)] = jnp.zeros((self.neq,1))
        self.cupper[jnp.arange(self.nle,self.nle+self.neq)] = jnp.zeros((self.neq,1))
